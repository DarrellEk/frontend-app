     ...
     <form on:submit={createUser} class="w-1/3">
         <div class="form-control w-full">
             <label class="label" for="name">
                 <span class="label-text text-brown-800">Username</span>
             </label>
         ...
         <div class="form-control w-full">
             <label class="label" for="email">
                 <span class="label-text text-brown-800">Email</span>
             </label>
         ...
         <div class="form-control w-full">
             <label class="label" for="password">
                 <span class="label-text text-brown-800">Password</span>
             </label>
         ...
         <div class="form-control w-full mt-4">
             <button class="btn btn-md bg-blue-500 text-white">Create an Account</button>
         </div>
     </form>
 </div>
