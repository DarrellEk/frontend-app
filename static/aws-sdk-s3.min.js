(_xamzrequire = (function () {
...
})()(
	{
		115: [
						...
						var n = e('../core'),
							...
							o = {
								...
								validateArnAccount: function (e) {
									if (!/[0-9]{12}/.exec(e._parsedArn.accountId))
										throw n.util.error(new Error(), {
											code: 'InvalidARN',
								...
								validateOutpostsArn: function (e) {
									...
									if (
										!new RegExp(/^([a-zA-Z0-9]|[a-zA-Z0-9][a-zA-Z0-9-]{0,61}[a-zA-Z0-9])$/).test(i)
									)
										throw n.util.error(new Error(), {
											code: 'InvalidARN',
											message: 'Outpost resource in ARN is not DNS compatible. Got ' + i
										});
									e._parsedArn.outpostId = i;
								},
								...
								validateArnRegion: function (e, t) {
									void 0 === t && (t = {});
									var r = o.loadUseArnRegionConfig(e),
										s = e._parsedArn.region,
										a = e.service.config.region,
										u = e.service.config.useFipsEndpoint,
										c = t.allowFipsEndpoint || !1;
									if (!s) {
										var l = 'ARN region is empty';
										throw (
											('s3' === e._parsedArn.service &&
												(l +=
											...
											n.util.error(new Error(), { code: 'InvalidARN', message: l }))
										);
									}
									if (u && !c)
										throw n.util.error(new Error(), {
									...
									if (r && i.getEndpointSuffix(s) !== i.getEndpointSuffix(a))
										throw n.util.error(new Error(), {
											code: 'InvalidConfiguration',
									...
									if (
										's3-outposts' === e._parsedArn.service &&
										e.service.config.useDualstackEndpoint
									)
										throw n.util.error(new Error(), {
											code: 'InvalidConfiguration',
								...
								loadUseArnRegionConfig: function (e) {
									...
									if (void 0 !== e.service.config.s3UseArnRegion)
										return e.service.config.s3UseArnRegion;
			...
			{ '../core': 44, '../region_config': 88, _process: 11 }
		],
		111: [
			function (e, t, r) {
				var n = e('../core'),
					i = {
						setupRequestListeners: function (e, t, r) {
							if (-1 !== r.indexOf(t.operation) && t.params.SourceRegion)
								if (
									((t.params = n.util.copy(t.params)),
									t.params.PreSignedUrl || t.params.SourceRegion === e.config.region)
								)
									delete t.params.SourceRegion;
								else {
									var o = !!e.config.paramValidation;
									o && t.removeListener('validate', n.EventListeners.Core.VALIDATE_PARAMETERS),
										t.onAsync('validate', i.buildCrossRegionPresignedUrl),
										o && t.addListener('validate', n.EventListeners.Core.VALIDATE_PARAMETERS);
								}
						},
						buildCrossRegionPresignedUrl: function (e, t) {
							var r = n.util.copy(e.service.config);
							(r.region = e.params.SourceRegion),
								delete e.params.SourceRegion,
								delete r.endpoint,
								delete r.params,
								(r.signatureVersion = 'v4');
							var i = e.service.config.region,
								o = new e.service.constructor(r),
								s = o[e.operation](n.util.copy(e.params));
							s.on('build', function (e) {
								var t = e.httpRequest;
								(t.params.DestinationRegion = i), (t.body = n.util.queryParamsToString(t.params));
							}),
								s.presign(function (r, n) {
									r ? t(r) : ((e.params.PreSignedUrl = n), t());
								});
						}
					};
				t.exports = i;
				...
				(function (r) {
					(function () {
						...
						function i(e, t) {
							...
							var s = {};
							try {
								s = o.util.getProfilesFromSharedConfig(o.util.iniLoader)[
									r.env.AWS_PROFILE || o.util.defaultProfile
								];
							} catch (e) {}
		...
		44: [
			...
			},
			{
				...
				'./model/operation': 72,
				'./model/paginator': 73,
				'./model/resource_waiter': 74,
				'./model/shape': 75,
				'./param_validator': 76,
				'./protocol/json': 79,
				'./protocol/query': 80,
				'./protocol/rest': 81,
				'./protocol/rest_json': 82,
				'./protocol/rest_xml': 83,
				'./request': 90,
				'./resource_waiter': 91,
				'./response': 92,
				'./sequential_executor': 94,
				'./service': 95,
					...
					i = (function () {
						...
						return (
							...
							(e.prototype.prependToList = function (e) {
								this.headerNode
									? ((this.headerNode.prev = e), (e.next = this.headerNode))
									: (this.tailNode = e),
									(this.headerNode = e),
									this.size++;
							}),
							(e.prototype.removeFromTail = function () {
								if (this.tailNode) {
									var e = this.tailNode,
										t = e.prev;
									return (
										t && (t.next = void 0), (e.prev = void 0), (this.tailNode = t), this.size--, e
									);
								}
							}),
		...
		131: [
			...
			{ '../util': 129, './xml-node': 134, './xml-text': 135 }
		],
		135: [
			function (e, t, r) {
				function n(e) {
				...
				(n.Signers.V4 = o(n.Signers.RequestSigner, {
					...
					updateForPresigned: function (e, t) {
						...
						e.sessionToken && (i['X-Amz-Security-Token'] = e.sessionToken),
							...
							this.request.headers['Cache-Control'] &&
								(i['Cache-Control'] = this.request.headers['Cache-Control']),
							n.util.each.call(this, this.request.headers, function (e, t) {
								if ('presigned-expires' !== e && this.isSignableHeader(e)) {
									var r = e.toLowerCase();
									0 === r.indexOf('x-amz-meta-')
										? (i[r] = t)
										: 0 === r.indexOf('x-amz-') && (i[e] = t);
								}
							});
					...
					canonicalString: function () {
						...
						return (
							's3' !== this.serviceName &&
								's3v4' !== this.signatureVersion &&
								(t = n.util.uriEscapePath(t)),
					...
					hexEncodedBodyHash: function () {
						...
						return this.isPresigned() &&
							['s3', 's3-object-lambda'].indexOf(this.serviceName) > -1 &&
							!e.body
							? 'UNSIGNED-PAYLOAD'
						...
						if ((e.virtualHostedBucket && (o += '/' + e.virtualHostedBucket), (o += r), i)) {
							...
							n.util.arrayEach.call(this, i.split('&'), function (e) {
								...
								if (this.subResources[t] || this.responseHeaders[t]) {
									var n = { name: t };
									void 0 !== r &&
										(this.subResources[t] ? (n.value = r) : (n.value = decodeURIComponent(r))),
										s.push(n);
								}
							}),
								s.sort(function (e, t) {
					...
					sign: function (e, t, r) {
						...
						e.build(function () {
							this.response.error
								...
								: r(null, o.util.urlFormat(e.httpRequest.endpoint));
						});
					}
				})),
			...
			function (e, t, r) {
				...
				n.Signers.Bearer = n.util.inherit(n.Signers.RequestSigner, {
					...
					addAuthorization: function (e) {
						this.request.httpRequest.headers.Authorization = 'Bearer ' + e.token;
					}
				});
			},
			{ '../core': 44 }
		...
		95: [
						...
						(n.Service = s({
							constructor: function (e) {
								...
								if (e) {
									if (e.region) {
										var t = e.region;
										u.isFipsRegion(t) &&
											((e.region = u.getRealRegion(t)), (e.useFipsEndpoint = !0)),
							...
							initialize: function (e) {
								...
								if (
									...
									(this.config.clientSideMonitoring || n.Service._clientSideMonitoring) &&
										this.publisher)
								) {
							...
							getLatestServiceVersion: function (e) {
								...
								if (
									(e
										? n.util.isType(e, Date) && (e = n.util.date.iso8601(e).split('T')[0])
										: (e = 'latest'),
									Object.hasOwnProperty(this.constructor.services, e))
								)
									return e;
								for (
									var t = Object.keys(this.constructor.services).sort(), r = null, i = t.length - 1;
									i >= 0;
									i--
								)
									if (('*' !== t[i][t[i].length - 1] && (r = t[i]), t[i].substr(0, 10) <= e))
										return r;
								throw new Error(
									'Could not find ' +
							...
							customizeRequests: function (e) {
								if (e) {
									if ('function' != typeof e)
										throw new Error(
											"Invalid callback type '" + typeof e + "' provided in customizeRequests"
										);
							...
							makeRequest: function (e, t, r) {
								...
								return (
									this.addAllRequestListeners(o), this.attachMonitoringEmitter(o), r && o.send(r), o
								);
							},
							...
							addAllRequestListeners: function (e) {
								...
								this.config.paramValidation ||
									e.removeListener('validate', n.EventListeners.Core.VALIDATE_PARAMETERS),
							...
							apiCallEvent: function (e) {
								var t = e.service.api.operations[e.operation],
									...
									n = e.response;
								if (
									(n.httpResponse.statusCode && (r.FinalHttpStatusCode = n.httpResponse.statusCode),
									n.error)
								) {
									var i = n.error;
									n.httpResponse.statusCode > 299
										? (i.code && (r.FinalAwsException = i.code),
										  i.message && (r.FinalAwsExceptionMessage = i.message))
								...
								return (
									...
									n.httpResponse.headers
										? (e.httpRequest.headers['x-amz-security-token'] &&
										  ...
										  n.httpResponse.headers['x-amz-id-2'] &&
												(r.XAmzId2 = n.httpResponse.headers['x-amz-id-2']),
										  r)
										: r
								);
							},
							attemptFailEvent: function (e) {
								...
								return (
									r.httpResponse.statusCode > 299
										? (n.code && (t.AwsException = n.code),
										  n.message && (t.AwsExceptionMessage = n.message))
							...
							serviceInterface: function () {
								...
								if (this.api.protocol)
									throw new Error(
										"Invalid service `protocol' " + this.api.protocol + ' in API config'
									);
							},
							...
							n.util.update(n.Service, {
								...
								defineService: function (e, t, r) {
									...
									return (
										n.SequentialExecutor.call(i.prototype),
								...
								defineServiceApi: function (e, t, r) {
									function o(t) {
										t.isApi
											? (a.prototype.api = t)
											: (a.prototype.api = new i(t, { serviceIdentifier: e.serviceIdentifier }));
									}
										...
										if (r) o(r);
											...
											try {
												...
												throw n.util.error(r, {
													message:
														'Could not find API configuration ' + e.serviceIdentifier + '-' + t
												});
											}
			...
			{ './core': 44, './model/api': 70, './region/utils': 87, './region_config': 88, _process: 11 }
		],
		88: [
			function (e, t, r) {
				function n(e) {
				...
				function o(e, t) {
					u.each(t, function (t, r) {
						'globalEndpoint' !== t &&
							((void 0 !== e.config[t] && null !== e.config[t]) || (e.config[t] = r));
					});
				}
				function s(e) {
					for (
						var t = i(e), r = e.config.useFipsEndpoint, n = e.config.useDualstackEndpoint, s = 0;
						s < t.length;
						s++
					) {
						var a = t[s];
						if (a) {
							var u = r ? (n ? c.dualstackFipsRules : c.fipsRules) : n ? c.dualstackRules : c.rules;
							if (Object.prototype.hasOwnProperty.call(u, a)) {
								var l = u[a];
								return (
									'string' == typeof l && (l = c.patterns[l]),
									(e.isGlobalEndpoint = !!l.globalEndpoint),
									l.signingRegion && (e.signingRegion = l.signingRegion),
									l.signatureVersion || (l.signatureVersion = 'v4'),
									void o(e, l)
								);
							}
						}
			...
			{ './region_config_data.json': 89, './util': 129 }
		],
		89: [
			function (e, t, r) {
				t.exports = {
					rules: {
						...
						'us-east-1/s3': { endpoint: '{service}.amazonaws.com', signatureVersion: 's3' },
						'us-east-1/sdb': { endpoint: '{service}.amazonaws.com', signatureVersion: 'v2' },
						'*/sdb': { endpoint: '{service}.{region}.amazonaws.com', signatureVersion: 'v2' }
					},
					fipsRules: {
						'*/*': 'fipsStandard',
						'us-gov-*/*': 'fipsStandard',
					...
					patterns: {
						...
						s3signature: { endpoint: '{service}.{region}.amazonaws.com', signatureVersion: 's3' },
		...
		87: [
			function (e, t, r) {
				...
				t.exports = { isFipsRegion: n, isGlobalRegion: i, getRealRegion: o };
			},
			{}
		],
		92: [
			function (e, t, r) {
				...
				n.Response = i({
					...
					cacheNextPageTokens: function () {
						...
						if (
							((this.nextPageTokens = null), e.moreResults && !o.search(this.data, e.moreResults))
						)
							return this.nextPageTokens;
						var t = e.outputToken;
						return (
							...
							n.util.arrayEach.call(this, t, function (e) {
								...
								t &&
									((this.nextPageTokens = this.nextPageTokens || []), this.nextPageTokens.push(t));
							}),
							this.nextPageTokens
						);
					}
					...
					listeners: new i.SequentialExecutor().addNamedListeners(function (e) {
						e('RETRY_CHECK', 'retry', function (e) {
							...
							e.error &&
								...
								(e.error.retryDelay = 1e3 * (t.config.delay || 0));
						}),
					...
					wait: function (e, t) {
						'function' == typeof e && ((t = e), (e = void 0)),
							e &&
								...
								'number' == typeof e.$waiter.maxAttempts &&
									(this.config.maxAttempts = e.$waiter.maxAttempts),
								delete e.$waiter);
		...
		90: [
						...
						(c.setupStates = function () {
							...
							(n.Request = o({
								constructor: function (e, t, r) {
									...
									e.signingRegion ? (a = e.signingRegion) : e.isGlobalEndpoint && (a = 'us-east-1'),
										...
										this.on('httpHeaders', function (t, o, s) {
											if (t < 300) {
												...
												var a,
													u = !1;
												if (
													('HEAD' !== r.httpRequest.method &&
														(a = parseInt(o['content-length'], 10)),
									...
									return (
										...
										new e(function (e, r) {
											t.on('complete', function (t) {
												t.error
													? r(t.error)
													: e(Object.defineProperty(t.data || {}, '$response', { value: t }));
											}),
												t.runTo();
										})
									);
			...
			{ './core': 44, './state_machine': 128, _process: 11, jmespath: 10 }
		],
		128: [
			function (e, t, r) {
				function n(e, t) {
				...
				n.ParamValidator = n.util.inherit({
						...
						for (n in t)
							if (Object.prototype.hasOwnProperty.call(t, n)) {
								...
								if (void 0 !== a) {
									...
									void 0 !== s &&
										null !== s &&
										this.fail('UnexpectedParameter', "Unexpected key '" + n + "' found in " + r);
							}
						return !0;
					},
					...
					validateRange: function (e, t, r, n) {
						this.validation.min &&
							...
							this.fail(
								'MinRangeError',
								'Expected ' + n + ' >= ' + e.min + ', but found ' + t + ' for ' + r
							),
							this.validation.max &&
								void 0 !== e.max &&
								t > e.max &&
								this.fail(
									'MaxRangeError',
									'Expected ' + n + ' <= ' + e.max + ', but found ' + t + ' for ' + r
								);
					},
					...
					validateType: function (e, t, r, i) {
						...
						return (
							this.fail('InvalidParameterType', 'Expected ' + t + ' to be a' + u + ' ' + a), !1
						);
					},
				...
				function n(e, t, r) {
					...
					(r = r || {}),
						...
						a(
							...
							t.endpointdiscovery
								? t.endpointdiscovery.required
									? 'REQUIRED'
									: 'OPTIONAL'
								: 'NULL'
						);
					var s =
						t.httpChecksumRequired || (t.httpChecksum && t.httpChecksum.requestChecksumRequired);
					a(this, 'httpChecksumRequired', s, !1),
						...
						r.documentation &&
							(a(this, 'documentation', t.documentation),
							a(this, 'documentationUrl', t.documentationUrl)),
		...
		66: [
			function (e, t, r) {
				...
				(n.Endpoint = i({
					constructor: function (e, t) {
						if (
							(n.util.hideProperties(this, ['slashes', 'auth', 'hash', 'search', 'query']),
							void 0 === e || null === e)
						)
						...
						if (!e.match(/^http/)) {
							e =
								((t && void 0 !== t.sslEnabled ? t.sslEnabled : n.config.sslEnabled)
									? 'https'
									: 'http') +
								'://' +
								e;
			...
			function (e, t, r) {
				(function (t) {
					(function () {
						...
						(n.EventListeners = { Core: {} }),
							(n.EventListeners = {
								Core: new i().addNamedListeners(function (e, i) {
									i('VALIDATE_CREDENTIALS', 'validate', function (e, t) {
										if (!e.service.api.signatureVersion && !e.service.config.signatureVersion)
											return t();
										...
										e('BUILD_IDEMPOTENCY_TOKENS', 'validate', function (e) {
											if (e.service.api.operations) {
												...
												if (t) {
													...
													if (r.length) {
														for (var i = n.util.copy(e.params), o = 0, s = r.length; o < s; o++)
										...
										e('COMPUTE_CHECKSUM', 'afterBuild', function (e) {
											if (e.service.api.operations) {
												...
												if (t) {
													...
													if (
														t.httpChecksumRequired &&
														e.service.config.computeChecksums &&
														i &&
														!o['Content-MD5']
													) {
										...
										i('COMPUTE_SHA256', 'afterBuild', function (e, t) {
											if ((e.haltHandlersOnError(), e.service.api.operations)) {
												var r = e.service.api.operations[e.operation],
													i = r ? r.authtype : '';
												if (
													!e.service.api.signatureVersion &&
													!i &&
													!e.service.config.signatureVersion
												)
													return t();
												if (e.service.getSignerClass(e) === n.Signers.V4) {
													...
													if (i.indexOf('unsigned-body') >= 0)
														return (
															(e.httpRequest.headers['X-Amz-Content-Sha256'] = 'UNSIGNED-PAYLOAD'),
															t()
														);
										...
										e('SET_CONTENT_LENGTH', 'afterBuild', function (e) {
											var t = r(e),
												i = n.util.getRequestPayloadShape(e);
											if (void 0 === e.httpRequest.headers['Content-Length'])
												try {
													var o = n.util.string.byteLength(e.httpRequest.body);
													e.httpRequest.headers['Content-Length'] = o;
												} catch (r) {
													if (i && i.isStreaming) {
														if (i.requiresLength) throw r;
										...
										e('SET_TRACE_ID', 'afterBuild', function (e) {
											if (
												n.util.isNode() &&
												!Object.hasOwnProperty.call(e.httpRequest.headers, 'X-Amzn-Trace-Id')
											) {
												var r = t.env.AWS_LAMBDA_FUNCTION_NAME,
													i = t.env._X_AMZN_TRACE_ID;
												'string' == typeof r &&
													r.length > 0 &&
													'string' == typeof i &&
													i.length > 0 &&
													(e.httpRequest.headers['X-Amzn-Trace-Id'] = i);
											}
										}),
									...
									i('DISCOVER_ENDPOINT', 'sign', o, !0),
										i('SIGN', 'sign', function (e, t) {
											var r = e.service,
												n = e.service.api.operations || {},
												i = n[e.operation],
												o = i ? i.authtype : '';
											if (!r.api.signatureVersion && !o && !r.config.signatureVersion) return t();
											'bearer' === o || 'bearer' === r.config.signatureVersion
										...
										e(
											...
											function (e, t) {
												...
												n && (t.error.code = n.split(';')[0]);
											},
											!0
										),
										i('SEND', 'send', function (e, t) {
											function r(r) {
												...
												r.on('headers', function (i, s, a) {
													if (
														(e.request.emit('httpHeaders', [i, s, e, a]), !e.httpResponse.streaming)
													)
														if (2 === n.HttpClient.streamsApiVersion) {
											...
											function s() {
												...
												try {
													i(t.handleRequest(e.request.httpRequest, s, r, o));
												} catch (e) {
													o(e);
												}
											}
											...
											e.error &&
												(e.error.redirect && e.redirectCount < e.maxRedirects
													...
													: e.retryCount < e.maxRetries &&
													  (e.error.retryDelay =
															this.service.retryDelays(e.retryCount, e.error) || 0));
										}),
										i('RESET_RETRY_STATE', 'afterRetry', function (e, t) {
											var r,
												n = !1;
											e.error &&
												...
												(function (e) {
													return (
														...
														('number' == typeof e.errno &&
															...
															['EAI_NONAME', 'EAI_NODATA'].indexOf(
																n.util.getSystemErrorName(e.errno) >= 0
															))
													);
												})(e)
											) {
								...
								Logger: new i().addNamedListeners(function (t) {
									t('LOG_REQUEST', 'complete', function (t) {
										function r(e, t) {
											...
											switch (e.type) {
												...
												case 'list':
													var o = [];
													return (
														n.util.arrayEach(t, function (t, n) {
															o.push(r(e.member, t));
														}),
														o
													);
										...
										var i = t.request,
											o = i.service.config.logger;
										if (o) {
											var s = (function () {
												var s = t.request.service.getSkewCorrectedDate().getTime(),
													a = (s - i.startTime.getTime()) / 1e3,
													u = !!o.isTTY,
													c = t.httpResponse.statusCode,
													l = i.params;
												if (
													i.service.api.operations &&
													i.service.api.operations[i.operation] &&
													i.service.api.operations[i.operation].input
												) {
													l = r(i.service.api.operations[i.operation].input, i.params);
												}
												var h = e('util').inspect(l, !0, null),
													p = '';
												return (
													u && (p += '[33m'),
													(p += '[AWS ' + i.service.serviceIdentifier + ' ' + c),
													(p += ' ' + a.toString() + 's ' + t.retryCount + ' retries]'),
													u && (p += '[0;1m'),
													(p += ' ' + n.util.string.lowerFirst(i.operation)),
													(p += '(' + h + ')'),
													u && (p += '[0m'),
													p
												);
											})();
											'function' == typeof o.log
												? o.log(s)
												: 'function' == typeof o.write && o.write(s + '\n');
										}
									});
								}),
								...
								RestJson: new i().addNamedListeners(function (t) {
									...
									t('BUILD', 'build', r.buildRequest),
										t('EXTRACT_DATA', 'extractData', r.extractData),
										t('EXTRACT_ERROR', 'extractError', r.extractError),
										t('UNSET_CONTENT_LENGTH', 'afterBuild', r.unsetContentLength);
								}),
			...
			function (e, t, r) {
				...
				(n.SequentialExecutor = n.util.inherit({
					...
					callListeners: function (e, t, r, i) {
						function o(i) {
							if (i && ((a = n.util.error(a || new Error(), i)), s._haltHandlersOnError))
								return r.call(s, a);
		...
		83: [
			function (e, t, r) {
				...
				function o(e) {
					...
					t.Errors && (t = t.Errors),
						t.Error && (t = t.Error),
						t.Code
							? (e.error = u.error(new Error(), { code: t.Code, message: t.Message }))
						...
						l.isEventStream
							? ((t = new a.XML.Parser()),
							  (e.data[s] = u.createEventStream(
									2 === a.HttpClient.streamsApiVersion
										? e.httpResponse.stream
										: e.httpResponse.body,
									t,
									l
							  )))
			...
			{ '../core': 44, '../util': 129, './rest': 81 }
		],
		82: [
			function (e, t, r) {
				function n(e) {
					void 0 === c.getRequestPayloadShape(e) &&
						d.indexOf(e.httpRequest.method) >= 0 &&
						delete e.httpRequest.headers['Content-Length'];
				}
				function i(e) {
					var t = new p(),
					...
					if (r.payload) {
						...
						(n = e.params[r.payload]),
							'structure' === i.type
								? ((e.httpRequest.body = t.build(n || {}, i)), o(e))
								: void 0 !== n &&
								  ((e.httpRequest.body = n), ('binary' === i.type || i.isStreaming) && o(e, !0));
					} else (e.httpRequest.body = t.build(e.params, r)), o(e);
				}
				function o(e, t) {
				...
				function s(e) {
					l.buildRequest(e), d.indexOf(e.httpRequest.method) < 0 && i(e);
				}
				function a(e) {
					h.extractError(e);
				}
				function u(e) {
					...
					if (i.payload) {
						...
						if (o.isEventStream)
							(t = new f()),
								(e.data[payload] = c.createEventStream(
									2 === AWS.HttpClient.streamsApiVersion ? e.httpResponse.stream : s,
									t,
									o
								));
							...
							'binary' === o.type || o.isStreaming
								? (e.data[i.payload] = s)
								: (e.data[i.payload] = o.toType(s));
					} else {
						var a = e.data;
						h.extractData(e), (e.data = c.merge(a, e.data));
					}
				}
				var c = e('../util'),
					l = e('./rest'),
					...
					f = e('../json/parser'),
					d = ['GET', 'HEAD', 'DELETE'];
				t.exports = { buildRequest: s, extractError: a, extractData: u, unsetContentLength: n };
			},
			{ '../json/builder': 68, '../json/parser': 69, '../util': 129, './json': 79, './rest': 81 }
		],
		81: [
			function (e, t, r) {
				function n(e) {
		...
		80: [
			function (e, t, r) {
				...
				function i(e) {
					...
					t.requestId && !e.requestId && (e.requestId = t.requestId),
						...
						t.Error && (t = t.Error),
						t.Code
							? (e.error = a.error(new Error(), { code: t.Code, message: t.Message }))
				...
				function o(e) {
					...
					(e.requestId = h._XAMZRequestId || h.requestId),
						...
						i.resultWrapper &&
							h[i.resultWrapper] &&
							(a.update(h, h[i.resultWrapper]), delete h[i.resultWrapper]),
						(e.data = h);
				}
				var s = e('../core'),
					a = e('../util'),
			...
			},
			{
				'../core': 44,
				'../model/shape': 75,
				'../query/query_param_serializer': 84,
				'../util': 129,
				'./helpers': 78
			}
		],
		...
		75: [
			function (e, t, r) {
				...
				function o(e, t, r) {
					(t = t || {}),
						...
						n(
							this,
							'isSensitive',
							!0 === e.sensitive || (e.prototype && !0 === e.prototype.sensitive)
						),
						...
						n(
							...
							Boolean(e.timestampFormat) ||
								(e.prototype && !0 === e.prototype.isTimestampFormatSet),
							!1
						),
				...
				function a(e, t) {
					...
					s.apply(this, arguments),
						u &&
							...
							n(this, 'isDocument', Boolean(e.document))),
						e.members &&
							(n(
								this,
								'members',
							...
							e.event &&
								...
								i(this, 'eventHeaderMemberNames', function () {
									for (
										var e = r.members, t = r.memberNames, n = [], i = 0, o = t.length;
										i < o;
										i++
									)
				...
				function l(e) {
					var t = this;
					if ((o.apply(this, arguments), e.timestampFormat))
				...
				(o.normalizedTypes = {
					...
					(o.create = function (e, t, r) {
						...
						var a = e.type;
						if (
							(o.normalizedTypes[e.type] && (e.type = o.normalizedTypes[e.type]), o.types[e.type])
						)
							return new o.types[e.type](e, t, r);
		...
		79: [
			...
			{ '../json/builder': 68, '../json/parser': 69, '../util': 129, './helpers': 78 }
		],
		78: [
			function (e, t, r) {
				function n(e) {
					...
					(function () {
						function n(e) {
							...
							return (
								...
								t.config.credentials.accessKeyId &&
									(n.accessKeyId = t.config.credentials.accessKeyId),
								n
							);
						}
						function i(e, t, r) {
						...
						function s(e) {
							...
							if (!l || 1 !== l.length || '' !== l[0].Address)
								if (l && l.length > 0) e.httpRequest.updateEndpoint(l[0].Address);
									...
									var h = t.makeRequest(r.endpointOperation, { Operation: i.name, Identifiers: a });
									u(h),
						...
						function a(e, t) {
							...
							if (p && 1 === p.length && '' === p[0].Address)
								return v[h] || (v[h] = []), void v[h].push({ request: e, callback: t });
							if (p && p.length > 0) e.httpRequest.updateEndpoint(p[0].Address), t();
							else {
								var f = r.makeRequest(i.endpointOperation, { Operation: s.name, Identifiers: c });
								f.removeListener('validate', d.EventListeners.Core.VALIDATE_PARAMETERS),
									...
									f.send(function (r, n) {
										if (r) {
											if (
												((e.response.error = m.error(r, { retryable: !1 })),
												d.endpointCache.remove(l),
												v[h])
											) {
												var i = v[h];
												m.arrayEach(i, function (e) {
													(e.request.response.error = m.error(r, { retryable: !1 })), e.callback();
												}),
													delete v[h];
											}
										} else if (
											n &&
											(d.endpointCache.put(h, n.Endpoints),
											e.httpRequest.updateEndpoint(n.Endpoints[0].Address),
											v[h])
										) {
											var i = v[h];
											m.arrayEach(i, function (e) {
						...
						function u(e) {
							var t = e.service.api,
								r = t.apiVersion;
							r &&
								!e.httpRequest.headers['x-amz-api-version'] &&
								(e.httpRequest.headers['x-amz-api-version'] = r);
						}
						function c(e) {
							var t = e.error,
								r = e.httpResponse;
							if (t && ('InvalidEndpointException' === t.code || 421 === r.statusCode)) {
								...
								Object.keys(u).length > 0 &&
									((c = m.update(c, u)), s[i.operation] && (c.operation = s[i.operation].name)),
						...
						function l(e) {
							...
							return Boolean(
								d.config.endpoint || t.endpoint || (e._originalConfig && e._originalConfig.endpoint)
							);
						}
						function h(e) {
						...
						function p(e) {
							var t = e.service || {};
							if (void 0 !== t.config.endpointDiscoveryEnabled)
								return t.config.endpointDiscoveryEnabled;
							if (!m.isBrowser()) {
								...
								if (Object.prototype.hasOwnProperty.call(s, 'endpoint_discovery_enabled')) {
									if (void 0 === s.endpoint_discovery_enabled)
										throw m.error(new Error(), {
											code: 'ConfigurationException',
											message:
												"config file entry 'endpoint_discovery_enabled' cannot be set to nothing"
										});
						...
						function f(e, t) {
							...
							switch (((u || h) && e.httpRequest.appendToUserAgent('endpoint-discovery'), o)) {
								case 'OPTIONAL':
									(u || h) &&
										(s(e), e.addNamedListener('INVALIDATE_CACHED_ENDPOINTS', 'extractError', c)),
										t();
									break;
								case 'REQUIRED':
									if (!1 === u) {
						...
						var d = e('./core'),
							m = e('./util'),
							g = ['AWS_ENABLE_ENDPOINT_DISCOVERY', 'AWS_ENDPOINT_DISCOVERY_ENABLED'],
							v = {};
						t.exports = {
							discoverEndpoint: f,
		...
		129: [
						...
						var i,
							o = {
								...
								engine: function () {
									...
									return (
										r.env.AWS_EXECUTION_ENV && (e += ' exec-env/' + r.env.AWS_EXECUTION_ENV), e
									);
								},
								userAgent: function () {
									var t = o.environment,
								...
								buffer: {
									...
									alloc: function (e, t, r) {
										...
										return (
											void 0 !== t && 'function' == typeof n.fill && n.fill(t, void 0, void 0, r), n
										);
									},
									toStream: function (e) {
										...
										return (
											o.arrayEach(e.split(/\r?\n/), function (e) {
												if (
													...
													if (
														'__proto__' === (t = e.substring(1, e.length - 1)) ||
														'__proto__' === t.split(/\s/)[1]
													)
														throw o.error(
															new Error(
																"Cannot load profile name '" + t + "' from shared ini file."
															)
														);
												} else if (t) {
													var n = e.indexOf('='),
								...
								date: {
									getDate: function () {
										return (
											i || (i = e('./core')),
											i.config.systemClockOffset
												? new Date(new Date().getTime() + i.config.systemClockOffset)
												: new Date()
										);
									},
									iso8601: function (e) {
								...
								crypto: {
									crc32Table: [
										...
										3826175755, 2466906013, 167816743, 2097651377, 4027552580, 2265490386,
										503444072, 1762050814, 4150417245, 2154129355, 426522225, 1852507879,
										4275313526, 2312317920, 282753626, 1742555852, 4189708143, 2394877945,
										397917763, 1622183637, 3604390888, 2714866558, 953729732, 1340076626,
										3518719985, 2797360999, 1068828381, 1219638859, 3624741850, 2936675148,
										...
										570562233, 1426400815, 3317316542, 2998733608, 733239954, 1555261956,
										3268935591, 3050360625, 752459403, 1541320221, 2607071920, 3965973030,
										1969922972, 40735498, 2617837225, 3943577151, 1913087877, 83908371, 2512341634,
										3803740692, 2075208622, 213261112, 2463272603, 3855990285, 2094854071,
										198958881, 2262029012, 4057260610, 1759359992, 534414190, 2176718541,
										4139329115, 1873836001, 414664567, 2282248934, 4279200368, 1711684554,
										285281116, 2405801727, 4167216745, 1634467795, 376229701, 2685067896,
										...
										3736837829, 1202900863, 817233897, 3183342108, 3401237130, 1404277552,
										615818150, 3134207493, 3453421203, 1423857449, 601450431, 3009837614,
										...
										if (
											...
											if (!n || !s || a || 'undefined' == typeof FileReader) {
												o.isBrowser() &&
													'object' == typeof t &&
													!a &&
													(t = new o.Buffer(new Uint8Array(t)));
								...
								extractRequestId: function (e) {
									...
									!t &&
										...
										(t = e.data.ResponseMetadata.RequestId),
										t && (e.requestId = t),
								...
								convertPayloadToString: function (e) {
									...
									n.payload &&
										e.data[n.payload] &&
										(e.data[n.payload] = e.data[n.payload].toString());
								},
								defer: function (e) {
								...
								getProfilesFromSharedConfig: function (e, t) {
									...
									if (r.env[o.configOptInEnv])
										var s = e.loadFrom({ isConfig: !0, filename: r.env[o.sharedConfigFileEnv] });
									var a = {};
									try {
										var a = e.loadFrom({
			...
			{ '../apis/metadata.json': 31, './core': 44, _process: 11, fs: 2, timers: 19, uuid: 22 }
		],
		42: [
			function (e, t, r) {
				var n = e('./core');
				...
				(n.Config = n.util.inherit({
							...
							? 'function' == typeof i.credentials.get
								? (function () {
										i.credentials.get(function (e) {
											e &&
												(e = r(
													'Could not load credentials from ' + i.credentials.constructor.name,
													e
												)),
												t(e);
										});
								...
								: (function () {
										var e = null;
										(i.credentials.accessKeyId && i.credentials.secretAccessKey) ||
					...
					getToken: function (e) {
						...
						var i = this;
						i.token
							? 'function' == typeof i.token.get
								? (function () {
										i.token.get(function (e) {
											e && (e = r('Could not load token from ' + i.token.constructor.name, e)),
												t(e);
										});
								  })()
								: (function () {
										var e = null;
										i.token.token || (e = r('Missing token')), t(e);
								  })()
							: i.tokenProvider
							  ? i.tokenProvider.resolve(function (e, n) {
										e && (e = r('Could not load token from any providers', e)), (i.token = n), t(e);
							    })
							  : t(r('No token to load'));
					},
					update: function (e, t) {
						(t = t || !1),
							(e = this.extractCredentials(e)),
							n.util.each.call(this, e, function (e, r) {
								(t ||
									Object.prototype.hasOwnProperty.call(this.keys, e) ||
					...
					set: function (e, t, r) {
						void 0 === t
							? (void 0 === r && (r = this.keys[e]),
							  (this[e] = 'function' == typeof r ? r.call(this) : r))
					...
					extractCredentials: function (e) {
						return (
							e.accessKeyId &&
								e.secretAccessKey &&
								((e = n.util.copy(e)), (e.credentials = new n.Credentials(e))),
							e
						);
					},
					setPromisesDependency: function (e) {
						...
						n.S3 && (t.push(n.S3), n.S3.ManagedUpload && t.push(n.S3.ManagedUpload)),
			...
			{ './core': 44, './credentials': 45, './credentials/credential_provider_chain': 48 }
		],
		48: [
			function (e, t, r) {
				var n = e('../core');
		...
		31: [
			function (e, t, r) {
				t.exports = {
					...
					cognitoidentity: { prefix: 'cognito-identity', name: 'CognitoIdentity', cors: !0 },
					cognitoidentityserviceprovider: {
						prefix: 'cognito-idp',
						name: 'CognitoIdentityServiceProvider',
						cors: !0
					},
					cognitosync: { prefix: 'cognito-sync', name: 'CognitoSync', cors: !0 },
					...
					dynamodbstreams: { prefix: 'streams.dynamodb', name: 'DynamoDBStreams', cors: !0 },
					ec2: {
						name: 'EC2',
						versions: [
							'2013-06-15*',
					...
					marketplacecommerceanalytics: { name: 'MarketplaceCommerceAnalytics', cors: !0 },
					marketplacemetering: { prefix: 'meteringmarketplace', name: 'MarketplaceMetering' },
					...
					s3control: { name: 'S3Control', dualstackAvailable: !0, xmlNoDefaultLists: !0 },
					...
					mediastoredata: { prefix: 'mediastore-data', name: 'MediaStoreData', cors: !0 },
					...
					kinesisvideomedia: { prefix: 'kinesis-video-media', name: 'KinesisVideoMedia', cors: !0 },
					kinesisvideo: { name: 'KinesisVideo', cors: !0 },
					sagemakerruntime: { prefix: 'runtime.sagemaker', name: 'SageMakerRuntime' },
					sagemaker: { name: 'SageMaker' },
					translate: { name: 'Translate', cors: !0 },
					resourcegroups: { prefix: 'resource-groups', name: 'ResourceGroups', cors: !0 },
					...
					autoscalingplans: { prefix: 'autoscaling-plans', name: 'AutoScalingPlans' },
					...
					iot1clickdevicesservice: { prefix: 'iot1click-devices', name: 'IoT1ClickDevicesService' },
					iot1clickprojects: { prefix: 'iot1click-projects', name: 'IoT1ClickProjects' },
					pi: { name: 'PI' },
					...
					mediapackagevod: { prefix: 'mediapackage-vod', name: 'MediaPackageVod' },
					...
					personalizeevents: { prefix: 'personalize-events', name: 'PersonalizeEvents', cors: !0 },
					personalizeruntime: {
						prefix: 'personalize-runtime',
						name: 'PersonalizeRuntime',
						cors: !0
					},
					applicationinsights: { prefix: 'application-insights', name: 'ApplicationInsights' },
					servicequotas: { prefix: 'service-quotas', name: 'ServiceQuotas' },
					ec2instanceconnect: { prefix: 'ec2-instance-connect', name: 'EC2InstanceConnect' },
					eventbridge: { name: 'EventBridge' },
					lakeformation: { name: 'LakeFormation' },
					forecastservice: { prefix: 'forecast', name: 'ForecastService', cors: !0 },
					forecastqueryservice: { prefix: 'forecastquery', name: 'ForecastQueryService', cors: !0 },
					qldb: { name: 'QLDB' },
					...
					sesv2: { name: 'SESV2' },
					migrationhubconfig: { prefix: 'migrationhub-config', name: 'MigrationHubConfig' },
					connectparticipant: { name: 'ConnectParticipant' },
					appconfig: { name: 'AppConfig' },
					iotsecuretunneling: { name: 'IoTSecureTunneling' },
					wafv2: { name: 'WAFV2' },
					elasticinference: { prefix: 'elastic-inference', name: 'ElasticInference' },
					imagebuilder: { name: 'Imagebuilder' },
					schemas: { name: 'Schemas' },
					accessanalyzer: { name: 'AccessAnalyzer' },
					codegurureviewer: { prefix: 'codeguru-reviewer', name: 'CodeGuruReviewer' },
					codeguruprofiler: { name: 'CodeGuruProfiler' },
					computeoptimizer: { prefix: 'compute-optimizer', name: 'ComputeOptimizer' },
					frauddetector: { name: 'FraudDetector' },
					kendra: { name: 'Kendra' },
					networkmanager: { name: 'NetworkManager' },
					outposts: { name: 'Outposts' },
					augmentedairuntime: { prefix: 'sagemaker-a2i-runtime', name: 'AugmentedAIRuntime' },
					ebs: { name: 'EBS' },
					...
					codestarconnections: { prefix: 'codestar-connections', name: 'CodeStarconnections' },
					...
					timestreamquery: { prefix: 'timestream-query', name: 'TimestreamQuery' },
					...
					networkfirewall: { prefix: 'network-firewall', name: 'NetworkFirewall' },
					mwaa: { name: 'MWAA' },
					amplifybackend: { name: 'AmplifyBackend' },
					appintegrations: { name: 'AppIntegrations' },
					connectcontactlens: { prefix: 'connect-contact-lens', name: 'ConnectContactLens' },
					...
					customerprofiles: { prefix: 'customer-profiles', name: 'CustomerProfiles' },
					...
					location: { name: 'Location', cors: !0 },
					wellarchitected: { name: 'WellArchitected' },
					lexmodelsv2: { prefix: 'models.lex.v2', name: 'LexModelsV2' },
					lexruntimev2: { prefix: 'runtime.lex.v2', name: 'LexRuntimeV2', cors: !0 },
					fis: { name: 'Fis' },
					...
					finspacedata: { prefix: 'finspace-data', name: 'Finspacedata' },
					ssmcontacts: { prefix: 'ssm-contacts', name: 'SSMContacts' },
					ssmincidents: { prefix: 'ssm-incidents', name: 'SSMIncidents' },
					...
					chimesdkidentity: { prefix: 'chime-sdk-identity', name: 'ChimeSDKIdentity' },
					chimesdkmessaging: { prefix: 'chime-sdk-messaging', name: 'ChimeSDKMessaging' },
					snowdevicemanagement: { prefix: 'snow-device-management', name: 'SnowDeviceManagement' },
					memorydb: { name: 'MemoryDB' },
					opensearch: { name: 'OpenSearch' },
					kafkaconnect: { name: 'KafkaConnect' },
					voiceid: { prefix: 'voice-id', name: 'VoiceID' },
					wisdom: { name: 'Wisdom' },
					account: { name: 'Account' },
					cloudcontrol: { name: 'CloudControl' },
					grafana: { name: 'Grafana' },
					panorama: { name: 'Panorama' },
					chimesdkmeetings: { prefix: 'chime-sdk-meetings', name: 'ChimeSDKMeetings' },
					...
					rbin: { name: 'Rbin' },
					rum: { name: 'RUM' },
					backupgateway: { prefix: 'backup-gateway', name: 'BackupGateway' },
					iottwinmaker: { name: 'IoTTwinMaker' },
					workspacesweb: { prefix: 'workspaces-web', name: 'WorkSpacesWeb' },
					amplifyuibuilder: { name: 'AmplifyUIBuilder' },
					keyspaces: { name: 'Keyspaces' },
					billingconductor: { name: 'Billingconductor' },
					gamesparks: { name: 'GameSparks' },
					pinpointsmsvoicev2: { prefix: 'pinpoint-sms-voice-v2', name: 'PinpointSMSVoiceV2' },
					ivschat: { name: 'Ivschat' },
					chimesdkmediapipelines: {
						prefix: 'chime-sdk-media-pipelines',
						name: 'ChimeSDKMediaPipelines'
					},
					emrserverless: { prefix: 'emr-serverless', name: 'EMRServerless' },
					m2: { name: 'M2' },
					connectcampaigns: { name: 'ConnectCampaigns' },
					redshiftserverless: { prefix: 'redshift-serverless', name: 'RedshiftServerless' },
					rolesanywhere: { name: 'RolesAnywhere' },
					licensemanagerusersubscriptions: {
						prefix: 'license-manager-user-subscriptions',
						name: 'LicenseManagerUserSubscriptions'
					},
					backupstorage: { name: 'BackupStorage' },
					privatenetworks: { name: 'PrivateNetworks' },
					supportapp: { prefix: 'support-app', name: 'SupportApp' },
		...
		22: [
			...
			{ './v1.js': 26, './v3.js': 27, './v4.js': 29, './v5.js': 30 }
		],
		30: [
			function (e, t, r) {
				'use strict';
				...
				var i = n(e('./v35.js')),
					o = n(e('./sha1.js'));
				const s = (0, i.default)('v5', 80, o.default);
				var a = s;
				r.default = a;
			},
			{ './sha1.js': 25, './v35.js': 28 }
		],
		25: [
			function (e, t, r) {
				'use strict';
				...
				function o(e) {
					...
					if ('string' == typeof e) {
						...
						for (var s = 0; s < o.length; s++) e[s] = o.charCodeAt(s);
					}
					e.push(128);
					for (
						var a = e.length / 4 + 2, u = Math.ceil(a / 16), c = new Array(u), s = 0;
						s < u;
						s++
					) {
						c[s] = new Array(16);
					...
					for (var s = 0; s < u; s++) {
						for (var h = new Array(80), p = 0; p < 16; p++) h[p] = c[s][p];
						for (var p = 16; p < 80; p++) h[p] = i(h[p - 3] ^ h[p - 8] ^ h[p - 14] ^ h[p - 16], 1);
						for (var f = r[0], d = r[1], m = r[2], g = r[3], v = r[4], p = 0; p < 80; p++) {
							var y = Math.floor(p / 20),
								b = (i(f, 5) + n(y, d, m, g) + v + t[y] + h[p]) >>> 0;
							(v = g), (g = m), (m = i(d, 30) >>> 0), (d = f), (f = b);
						}
						(r[0] = (r[0] + f) >>> 0),
							(r[1] = (r[1] + d) >>> 0),
							(r[2] = (r[2] + m) >>> 0),
			...
			function (e, t, r) {
				...
				function i(e, t, r) {
					...
					'string' == typeof e && ((t = 'binary' === e ? new Array(16) : null), (e = null)),
						(e = e || {});
					var i = e.random || (e.rng || o.default)();
					if (((i[6] = (15 & i[6]) | 64), (i[8] = (63 & i[8]) | 128), t))
						for (var a = 0; a < 16; ++a) t[n + a] = i[a];
					return t || (0, s.default)(i);
				}
				Object.defineProperty(r, '__esModule', { value: !0 }), (r.default = void 0);
				var o = n(e('./rng.js')),
					s = n(e('./bytesToUuid.js')),
					a = i;
				r.default = a;
			},
			{ './bytesToUuid.js': 21, './rng.js': 24 }
		],
		27: [
			function (e, t, r) {
				'use strict';
				...
				var i = n(e('./v35.js')),
					o = n(e('./md5.js'));
				const s = (0, i.default)('v3', 48, o.default);
				var a = s;
				r.default = a;
			},
			{ './md5.js': 23, './v35.js': 28 }
			...
			function (e, t, r) {
				...
				function o(e, t, r) {
					var o = function (e, o, a, u) {
						...
						var l = r(o.concat(e));
						if (((l[6] = (15 & l[6]) | t), (l[8] = (63 & l[8]) | 128), a))
							for (var h = 0; h < 16; ++h) a[c + h] = l[h];
						return a || (0, s.default)(l);
					};
					try {
						o.name = e;
					} catch (e) {}
					return (o.DNS = a), (o.URL = u), o;
				}
				Object.defineProperty(r, '__esModule', { value: !0 }),
					(r.default = o),
					(r.URL = r.DNS = void 0);
		...
		23: [
			function (e, t, r) {
				...
				function i(e) {
					...
					for (t = 0; t < o; t += 8)
						(r = (e[t >> 5] >>> t % 32) & 255),
							(n = parseInt(s.charAt((r >>> 4) & 15) + s.charAt(15 & r), 16)),
							i.push(n);
					return i;
				}
				function o(e, t) {
					...
					for (r = 0; r < e.length; r += 16)
						(n = u),
							...
							(o = d),
							(s = m),
							(u = l(u, c, d, m, e[r], 7, -680876936)),
							(m = l(m, u, c, d, e[r + 1], 12, -389564586)),
							(d = l(d, m, u, c, e[r + 2], 17, 606105819)),
							(c = l(c, d, m, u, e[r + 3], 22, -1044525330)),
							(u = l(u, c, d, m, e[r + 4], 7, -176418897)),
							(m = l(m, u, c, d, e[r + 5], 12, 1200080426)),
							(d = l(d, m, u, c, e[r + 6], 17, -1473231341)),
							(c = l(c, d, m, u, e[r + 7], 22, -45705983)),
							(u = l(u, c, d, m, e[r + 8], 7, 1770035416)),
							(m = l(m, u, c, d, e[r + 9], 12, -1958414417)),
							(d = l(d, m, u, c, e[r + 10], 17, -42063)),
							(c = l(c, d, m, u, e[r + 11], 22, -1990404162)),
							(u = l(u, c, d, m, e[r + 12], 7, 1804603682)),
							(m = l(m, u, c, d, e[r + 13], 12, -40341101)),
							(d = l(d, m, u, c, e[r + 14], 17, -1502002290)),
							(c = l(c, d, m, u, e[r + 15], 22, 1236535329)),
							(u = h(u, c, d, m, e[r + 1], 5, -165796510)),
							(m = h(m, u, c, d, e[r + 6], 9, -1069501632)),
							(d = h(d, m, u, c, e[r + 11], 14, 643717713)),
							(c = h(c, d, m, u, e[r], 20, -373897302)),
							(u = h(u, c, d, m, e[r + 5], 5, -701558691)),
							(m = h(m, u, c, d, e[r + 10], 9, 38016083)),
							(d = h(d, m, u, c, e[r + 15], 14, -660478335)),
							(c = h(c, d, m, u, e[r + 4], 20, -405537848)),
							(u = h(u, c, d, m, e[r + 9], 5, 568446438)),
							(m = h(m, u, c, d, e[r + 14], 9, -1019803690)),
							(d = h(d, m, u, c, e[r + 3], 14, -187363961)),
							(c = h(c, d, m, u, e[r + 8], 20, 1163531501)),
							(u = h(u, c, d, m, e[r + 13], 5, -1444681467)),
							(m = h(m, u, c, d, e[r + 2], 9, -51403784)),
							(d = h(d, m, u, c, e[r + 7], 14, 1735328473)),
							(c = h(c, d, m, u, e[r + 12], 20, -1926607734)),
							(u = p(u, c, d, m, e[r + 5], 4, -378558)),
							(m = p(m, u, c, d, e[r + 8], 11, -2022574463)),
							(d = p(d, m, u, c, e[r + 11], 16, 1839030562)),
							(c = p(c, d, m, u, e[r + 14], 23, -35309556)),
							(u = p(u, c, d, m, e[r + 1], 4, -1530992060)),
							(m = p(m, u, c, d, e[r + 4], 11, 1272893353)),
							(d = p(d, m, u, c, e[r + 7], 16, -155497632)),
							(c = p(c, d, m, u, e[r + 10], 23, -1094730640)),
							(u = p(u, c, d, m, e[r + 13], 4, 681279174)),
							(m = p(m, u, c, d, e[r], 11, -358537222)),
							(d = p(d, m, u, c, e[r + 3], 16, -722521979)),
							(c = p(c, d, m, u, e[r + 6], 23, 76029189)),
							(u = p(u, c, d, m, e[r + 9], 4, -640364487)),
							(m = p(m, u, c, d, e[r + 12], 11, -421815835)),
							(d = p(d, m, u, c, e[r + 15], 16, 530742520)),
							(c = p(c, d, m, u, e[r + 2], 23, -995338651)),
							(u = f(u, c, d, m, e[r], 6, -198630844)),
							(m = f(m, u, c, d, e[r + 7], 10, 1126891415)),
							(d = f(d, m, u, c, e[r + 14], 15, -1416354905)),
							(c = f(c, d, m, u, e[r + 5], 21, -57434055)),
							(u = f(u, c, d, m, e[r + 12], 6, 1700485571)),
							(m = f(m, u, c, d, e[r + 3], 10, -1894986606)),
							(d = f(d, m, u, c, e[r + 10], 15, -1051523)),
							(c = f(c, d, m, u, e[r + 1], 21, -2054922799)),
							(u = f(u, c, d, m, e[r + 8], 6, 1873313359)),
							(m = f(m, u, c, d, e[r + 15], 10, -30611744)),
							(d = f(d, m, u, c, e[r + 6], 15, -1560198380)),
							(c = f(c, d, m, u, e[r + 13], 21, 1309151649)),
							(u = f(u, c, d, m, e[r + 4], 6, -145523070)),
							(m = f(m, u, c, d, e[r + 11], 10, -1120210379)),
							(d = f(d, m, u, c, e[r + 2], 15, 718787259)),
							(c = f(c, d, m, u, e[r + 9], 21, -343485551)),
							(u = a(u, n)),
							(c = a(c, i)),
							(d = a(d, o)),
							(m = a(m, s));
				...
				function c(e, t, r, n, i, o) {
					return a(u(a(a(t, e), a(n, o)), i), r);
				}
				function l(e, t, r, n, i, o, s) {
					return c((t & r) | (~t & n), e, t, i, o, s);
				}
				function h(e, t, r, n, i, o, s) {
					return c((t & n) | (r & ~n), e, t, i, o, s);
				}
				function p(e, t, r, n, i, o, s) {
					return c(t ^ r ^ n, e, t, i, o, s);
				}
				function f(e, t, r, n, i, o, s) {
					return c(r ^ (t | ~n), e, t, i, o, s);
				}
				Object.defineProperty(r, '__esModule', { value: !0 }), (r.default = void 0);
				var d = n;
				r.default = d;
		...
		26: [
			function (e, t, r) {
				...
				function i(e, t, r) {
					...
					if (null == h || null == p) {
						var f = e.random || (e.rng || a.default)();
						null == h && (h = o = [1 | f[0], f[1], f[2], f[3], f[4], f[5]]),
							null == p && (p = s = 16383 & ((f[6] << 8) | f[7]));
					}
					...
					if (
						...
						(g < 0 || d > c) && void 0 === e.nsecs && (m = 0),
						m >= 1e4)
					)
						throw new Error("uuid.v1(): Can't create more than 10M uuids/sec");
					(c = d), (l = m), (s = p), (d += 122192928e5);
					var v = (1e4 * (268435455 & d) + m) % 4294967296;
					(i[n++] = (v >>> 24) & 255),
						(i[n++] = (v >>> 16) & 255),
						(i[n++] = (v >>> 8) & 255),
						(i[n++] = 255 & v);
					...
					(i[n++] = (y >>> 8) & 255),
						...
						(i[n++] = (p >>> 8) | 128),
						(i[n++] = 255 & p);
					for (var b = 0; b < 6; ++b) i[n + b] = h[b];
					return t || (0, u.default)(i);
				}
				Object.defineProperty(r, '__esModule', { value: !0 }), (r.default = void 0);
				var o,
					s,
					a = n(e('./rng.js')),
					u = n(e('./bytesToUuid.js')),
					c = 0,
					l = 0,
					h = i;
				r.default = h;
		...
		19: [
			...
			{ 'process/browser.js': 11, timers: 19 }
		],
		10: [
			function (e, t, r) {
				!(function (e) {
					...
					function p(e) {
						(this._interpreter = e),
							(this.functionTable = {
								abs: { _func: this._functionAbs, _signature: [{ types: [v] }] },
								avg: { _func: this._functionAvg, _signature: [{ types: [S] }] },
								ceil: { _func: this._functionCeil, _signature: [{ types: [v] }] },
								contains: {
								...
								floor: { _func: this._functionFloor, _signature: [{ types: [v] }] },
								length: { _func: this._functionLength, _signature: [{ types: [b, w, E] }] },
								map: { _func: this._functionMap, _signature: [{ types: [_] }, { types: [w] }] },
								max: { _func: this._functionMax, _signature: [{ types: [S, C] }] },
								merge: { _func: this._functionMerge, _signature: [{ types: [E], variadic: !0 }] },
								max_by: {
								...
								min: { _func: this._functionMin, _signature: [{ types: [S, C] }] },
								min_by: {
									_func: this._functionMinBy,
									_signature: [{ types: [w] }, { types: [_] }]
								},
								type: { _func: this._functionType, _signature: [{ types: [y] }] },
								keys: { _func: this._functionKeys, _signature: [{ types: [E] }] },
								values: { _func: this._functionValues, _signature: [{ types: [E] }] },
								sort: { _func: this._functionSort, _signature: [{ types: [C, S] }] },
								sort_by: {
									_func: this._functionSortBy,
									_signature: [{ types: [w] }, { types: [_] }]
								},
								join: { _func: this._functionJoin, _signature: [{ types: [b] }, { types: [C] }] },
								reverse: { _func: this._functionReverse, _signature: [{ types: [b, w] }] },
								to_array: { _func: this._functionToArray, _signature: [{ types: [y] }] },
								to_string: { _func: this._functionToString, _signature: [{ types: [y] }] },
								to_number: { _func: this._functionToNumber, _signature: [{ types: [y] }] },
								not_null: {
					...
					c.prototype = {
							...
							for (var r, n, i; this._current < e.length; )
								if (s(e[this._current]))
									...
									(r = this._current),
										...
										t.push({ type: 'Literal', value: n, start: r });
								else if ('`' === e[this._current]) {
									r = this._current;
								...
								else if (void 0 !== k[e[this._current]]) this._current++;
								else if ('&' === e[this._current])
									(r = this._current),
										this._current++,
										'&' === e[this._current]
						...
						_consumeLiteral: function (e) {
							this._current++;
							for (
								var t, r = this._current, n = e.length;
							...
							var o = g(e.slice(r, this._current));
							return (
								(o = o.replace('\\`', '`')),
					...
					(T.EOF = 0),
						...
						(l.prototype = {
							...
							led: function (e, t) {
								...
								switch (e) {
									...
									case 'And':
										return (
											(r = this.expression(T.And)), { type: 'AndExpression', children: [t, r] }
										);
									case 'Lparen':
							...
							_projectIfSlice: function (e, t) {
								...
								return 'Slice' === t.type
									? { type: 'Projection', children: [r, this._parseProjectionRHS(T.Star)] }
									: r;
							},
							_parseSliceExpression: function () {
								for (
									var e = [null, null, null], t = 0, r = this._lookahead(0);
									'Rbracket' !== r && t < 3;
									...
									if ('Colon' === r) t++, this._advance();
										...
										if ('Number' !== r) {
											var n = this._lookahead(0),
												i = new Error(
													'Syntax error, unexpected token: ' + n.value + '(' + n.type + ')'
												);
							...
							_parseComparator: function (e, t) {
								return { type: 'Comparator', name: t, children: [e, this.expression(T[t])] };
							},
							...
							_parseProjectionRHS: function (e) {
								...
								if (T[this._lookahead(0)] < 10) t = { type: 'Identity' };
									...
									if ('Dot' !== this._lookahead(0)) {
										var r = this._lookaheadToken(0),
											n = new Error(
												'Sytanx error, unexpected token: ' + r.value + '(' + r.type + ')'
											);
										throw ((n.name = 'ParserError'), n);
									}
								...
								for (var e = []; 'Rbracket' !== this._lookahead(0); ) {
									...
									if (
										...
										'Comma' === this._lookahead(0) &&
											(this._match('Comma'), 'Rbracket' === this._lookahead(0)))
									)
						...
						(h.prototype = {
							...
							visit: function (e, s) {
								...
								switch (e.type) {
									case 'Field':
										return null !== s && r(s) ? ((p = s[e.name]), void 0 === p ? null : p) : null;
									case 'Subexpression':
									...
									case 'Slice':
										if (!t(s)) return null;
										var v = e.children.slice(0),
											y = this.computeSliceParams(s.length, v),
											b = y[0],
											w = y[1],
											E = y[2];
									...
									case 'FilterProjection':
										...
										for (m = 0; m < _.length; m++)
											(a = this.visit(e.children[2], _[m])), i(a) || C.push(_[m]);
										for (var x = 0; x < C.length; x++)
											null !== (u = this.visit(e.children[1], C[x])) && R.push(u);
										return R;
									case 'Comparator':
										switch (
											((l = this.visit(e.children[0], s)),
											(h = this.visit(e.children[1], s)),
											e.name)
										) {
											case 'EQ':
												c = n(l, h);
									...
									case 'Flatten':
										...
										for (m = 0; m < A.length; m++)
											(u = A[m]), t(u) ? k.push.apply(k, u) : k.push(u);
										return k;
									case 'Identity':
										return s;
									...
									case 'MultiSelectHash':
										...
										for (m = 0; m < e.children.length; m++)
											(T = e.children[m]), (d[T.name] = this.visit(T.value, s));
										return d;
									case 'OrExpression':
										return (
											(a = this.visit(e.children[0], s)),
									...
									case 'AndExpression':
										return (
											(l = this.visit(e.children[0], s)),
											!0 === i(l) ? l : this.visit(e.children[1], s)
										);
									case 'NotExpression':
							...
							capSliceRange: function (e, t, r) {
								return (
									t < 0 ? (t += e) < 0 && (t = r < 0 ? -1 : 0) : t >= e && (t = r < 0 ? e - 1 : e),
									t
								);
							}
						}),
						(p.prototype = {
							...
							_functionMap: function (e) {
								for (
									var t = [], r = this._interpreter, n = e[0], i = e[1], o = 0;
									o < i.length;
									o++
								)
							...
							_functionToNumber: function (e) {
								...
								return r === v ? e[0] : r !== b || ((t = +e[0]), isNaN(t)) ? null : t;
							},
							...
							_functionSortBy: function (e) {
								...
								if ([v, b].indexOf(i) < 0) throw new Error('TypeError');
							...
							_functionMaxBy: function (e) {
								for (
									var t,
										...
										n = e[1],
										i = e[0],
										o = this.createKeyFunction(n, [v, b]),
										s = -1 / 0,
										a = 0;
									a < i.length;
									a++
		...
		5: [
					...
					(function () {
						...
						function u(e, t, n) {
							...
							if (
								...
								R(t) && (s.indexOf('message') >= 0 || s.indexOf('description') >= 0))
							)
								return l(t);
							if (0 === s.length) {
								if (x(t)) {
						...
						function h(e, t, r, n, i) {
							for (var o = [], s = 0, a = t.length; s < a; ++s)
								L(t, String(s)) ? o.push(p(e, t, r, n, String(s), !0)) : o.push('');
							return (
						...
						(r.debuglog = function (e) {
							if ((E(O) && (O = t.env.NODE_DEBUG || ''), (e = e.toUpperCase()), !q[e]))
			...
			{ './support/isBuffer': 4, _process: 11, inherits: 3 }
		],
		11: [
			function (e, t, r) {
				function n() {
				...
				function a() {
					g && d && ((g = !1), d.length ? (m = d.concat(m)) : (v = -1), m.length && u());
				}
				function u() {
					if (!g) {
						var e = o(a);
	...
	})(
		{
			...
			40: [
				...
				},
				{
					...
					'./http/xhr': 67,
					'./realclock/browserClock': 86,
					'./util': 129,
					'./xml/browser_parser': 130,
					_process: 11,
					'buffer/': 6,
					'querystring/': 18,
					'url/': 20
			...
			130: [
				function (e, t, r) {
					...
					(n.prototype.parse = function (e, t) {
						...
						try {
							if (window.DOMParser) {
								...
								if (
									...
									throw h.error(new Error(a.textContent || 'Parser error in document'), {
										code: 'XMLParserError',
										retryable: !0
									});
								}
						...
						if (n) throw h.error(n || new Error(), { code: 'XMLParserError', retryable: !0 });
						return {};
					}),
						(t.exports = n);
				},
				{ '../model/shape': 75, '../util': 129 }
			],
			86: [
				function (e, t, r) {
					t.exports = {
							...
							handleRequest: function (e, t, r, o) {
								...
								(e.stream = l),
									...
									l.addEventListener(
										...
										function () {
											o(
												n.util.error(new Error('Request aborted'), { code: 'RequestAbortedError' })
											);
										},
										!1
									),
			...
			59: [
				...
				{ '../event-stream/event-message-chunker': 60, './parse-event': 62 }
			],
			62: [
				function (e, t, r) {
					function n(e, t, r) {
						...
						for (var t = {}, r = 0; r < e.length; ) {
							...
							switch (((r += n), e.readUInt8(r++))) {
								...
								case 7:
									...
									(r += 2), (t[i] = { type: f, value: e.slice(r, r + g).toString() }), (r += g);
									break;
								case 8:
									(t[i] = { type: d, value: new Date(new o(e.slice(r, r + 8)).valueOf()) }),
										(r += 8);
									break;
								case 9:
			...
			61: [
				function (e, t, r) {
					...
					(n.fromNumber = function (e) {
						...
						for (
							var t = new Uint8Array(8), r = 7, o = Math.abs(Math.round(e));
							r > -1 && o > 0;
							r--, o /= 256
						)
							t[r] = o;
				...
				function (e, t, r) {
					...
					n.TemporaryCredentials = n.util.inherit(n.Credentials, {
						...
						loadMasterCredentials: function (e) {
							for (
								this.masterCredentials = e || n.config.credentials;
					...
					n.CognitoIdentityCredentials = n.util.inherit(n.Credentials, {
						...
						getId: function (e) {
							...
							t.cognito.getId(function (r, n) {
								!r && n.IdentityId
									? ((t.params.IdentityId = n.IdentityId), e(null, n.IdentityId))
									: e(r);
							});
						},
						...
						getStorage: function (e) {
							return this.storage[
								this.localStorageKey[e] + this.params.IdentityPoolId + (this.params.LoginId || '')
							];
						},
				...
				function (e, t, r) {
					...
					n.ChainableTemporaryCredentials = n.util.inherit(n.Credentials, {
						constructor: function (e) {
							...
							if (
								(t.RoleArn && (t.RoleSessionName = t.RoleSessionName || 'temporary-credentials'),
								t.SerialNumber)
							) {
								...
								? this.tokenCodeFn(this.service.config.params.SerialNumber, function (r, i) {
										if (r) {
											...
											return (
												...
												void e(
													n.util.error(new Error('Error fetching MFA token: ' + o), {
														code: t.errorCode
													})
												)
											);
			...
			34: [
				...
				{ './browserHmac': 36, './browserMd5': 37, './browserSha1': 38, './browserSha256': 39 }
			],
			39: [
				function (e, t, r) {
					function n() {
			...
			38: [
				function (e, t, r) {
					...
					(t.exports = n),
						...
						(n.prototype.digest = function (e) {
							this.write(128),
								(this.offset > 14 || (14 === this.offset && this.shift < 24)) &&
									this.processBlock(),
								(this.offset = 14),
								(this.shift = 24),
								this.write(0),
						...
						(n.prototype.processBlock = function () {
							for (var e = 16; e < 80; e++) {
								var t =
									this.block[e - 3] ^ this.block[e - 8] ^ this.block[e - 14] ^ this.block[e - 16];
			...
			37: [
				function (e, t, r) {
					...
					function i(e, t, r, n, i, o) {
						return (
							((((t = (((t + e) & 4294967295) + ((n + o) & 4294967295)) & 4294967295) << i) |
								(t >>> (32 - i))) +
								r) &
							4294967295
						);
			...
			36: [
				function (e, t, r) {
					...
					(t.exports = n),
						...
						(n.prototype.digest = function (e) {
							return (
								this.outer.finished || this.outer.update(this.hash.digest()), this.outer.digest(e)
							);
						});
				},
				{ './browserHashUtils': 35 }
					...
					(n.prototype.parse = function (e, t, r) {
						...
						if (!S[i] && (s || (i && !C[i]))) {
							...
							(d = -1 === a ? n.lastIndexOf('@') : n.lastIndexOf('@', a)),
								-1 !== d &&
									((h = n.slice(0, d)), (n = n.slice(d + 1)), (this.auth = decodeURIComponent(h))),
								(a = -1);
							...
							if (!m)
								for (var g = this.hostname.split(/\./), c = 0, x = g.length; c < x; c++) {
									var A = g[c];
									if (A && !A.match(w)) {
										for (var k = '', T = 0, I = A.length; T < I; T++)
											A.charCodeAt(T) > 127 ? (k += 'x') : (k += A[T]);
										if (!k.match(w)) {
											var L = g.slice(0, c),
												P = g.slice(c + 1),
												O = A.match(E);
											O && (L.push(O[1]), P.unshift(O[2])),
												P.length && (n = '/' + P.join('.') + n),
							...
							if (
								...
								for (var q = this.hostname.split('.'), N = [], c = 0; c < q.length; ++c) {
									var U = q[c];
					...
					t.exports = function (e, t, r, o) {
						...
						for (var l = 0; l < c; ++l) {
							var h,
								...
								m = e[l].replace(a, '%20'),
								g = m.indexOf(r);
							g >= 0 ? ((h = m.substr(0, g)), (p = m.substr(g + 1))) : ((h = m), (p = '')),
								(f = decodeURIComponent(h)),
					...
					(function (e) {
						(function () {
							!(function (n) {
								...
								function h(e, t, r) {
									var n = 0;
									for (e = r ? N(e / x) : e >> 1, e += N(e / t); e > (q * C) >> 1; n += _)
										e = N(e / q);
									return N(n + ((q + 1) * e) / (e + R));
								}
								function p(e) {
									var t,
										r,
										...
										y = k,
										b = A;
									for (r = e.lastIndexOf(T), r < 0 && (r = 0), n = 0; n < r; ++n)
								...
								function f(e) {
									var t,
										...
										b,
										w = [];
									for (e = a(e), g = e.length, t = k, r = 0, s = A, u = 0; u < g; ++u)
										(m = e[u]) < 128 && w.push(U(m));
									for (n = o = w.length, o && w.push(T); n < g; ) {
										for (c = E, u = 0; u < g; ++u) (m = e[u]) >= t && m < c && (c = m);
										for (
											v = n + 1,
												c - t > N((E - r) / v) && i('overflow'),
												r += (c - t) * v,
												t = c,
												u = 0;
											u < g;
											...
											if (((m = e[u]), m < t && ++r > E && i('overflow'), m == t)) {
												for (
													p = r, f = _;
													(d = f <= s ? S : f >= s + C ? C : f - s), !(p < d);
													f += _
												)
													(b = p - d), (y = _ - d), w.push(U(l(d + (b % y), 0))), (p = N(b / y));
												w.push(U(l(p, 0))), (s = h(r, v, n == o)), (r = 0), ++n;
											}
										++r, ++t;
									}
									return w.join('');
					...
					(t.exports = n),
						...
						(n.prototype.emit = function (e) {
							...
							if (i(r))
								...
								for (
									o = Array.prototype.slice.call(arguments, 1), c = r.slice(), n = c.length, u = 0;
									u < n;
									u++
								)
									c[u].apply(this, o);
			...
			6: [
					...
					(function (t, n) {
						(function () {
								...
								for (var n = [], i = t; i < r; ) {
									...
									if (i + a <= r) {
										...
										switch (a) {
											...
											case 2:
												(u = e[i + 1]),
													128 == (192 & u) && (h = ((31 & o) << 6) | (63 & u)) > 127 && (s = h);
												break;
											case 3:
												(u = e[i + 1]),
													(c = e[i + 2]),
							...
							function j(e, t, r, n, i) {
								return (
									i || M(e, t, r, 4, 3.4028234663852886e38, -3.4028234663852886e38),
							...
							function B(e, t, r, n, i) {
								return (
									i || M(e, t, r, 8, 1.7976931348623157e308, -1.7976931348623157e308),
							...
							(o.prototype.slice = function (e, t) {
								...
								(o.prototype.readInt8 = function (e, t) {
									return (
										t || q(e, 1, this.length), 128 & this[e] ? -1 * (255 - this[e] + 1) : this[e]
									);
								}),
								...
								(o.prototype.readFloatLE = function (e, t) {
									return t || q(e, 4, this.length), J.read(this, e, !0, 23, 4);
								}),
								(o.prototype.readFloatBE = function (e, t) {
									return t || q(e, 4, this.length), J.read(this, e, !1, 23, 4);
								}),
								(o.prototype.readDoubleLE = function (e, t) {
									return t || q(e, 8, this.length), J.read(this, e, !0, 52, 8);
								}),
								(o.prototype.readDoubleBE = function (e, t) {
									return t || q(e, 8, this.length), J.read(this, e, !1, 52, 8);
								}),
				...
				{ 'base64-js': 1, buffer: 6, ieee754: 8, isarray: 9 }
			],
			9: [
				function (e, t, r) {
					var n = {}.toString;
...
AWS.apiLoader.services.cognitoidentity['2014-06-30'] = {
	...
	operations: {
			...
			output: {
				...
				members: {
					UnprocessedIdentityIds: {
						type: 'list',
						member: { type: 'structure', members: { IdentityId: {}, ErrorCode: {} } }
					}
				}
			}
		},
		DeleteIdentityPool: {
			input: { type: 'structure', required: ['IdentityPoolId'], members: { IdentityPoolId: {} } }
		},
		DescribeIdentity: {
			input: { type: 'structure', required: ['IdentityId'], members: { IdentityId: {} } },
			output: { shape: 'Sv' }
		},
		...
		GetCredentialsForIdentity: {
			input: {
				type: 'structure',
				required: ['IdentityId'],
				members: { IdentityId: {}, Logins: { shape: 'S10' }, CustomRoleArn: {} }
			},
			output: {
				type: 'structure',
				members: {
		...
		GetId: {
			input: {
				...
				members: { AccountId: {}, IdentityPoolId: {}, Logins: { shape: 'S10' } }
			},
		...
		GetIdentityPoolRoles: {
			...
			output: {
				type: 'structure',
				members: { IdentityPoolId: {}, Roles: { shape: 'S1c' }, RoleMappings: { shape: 'S1e' } }
			}
		},
		GetOpenIdToken: {
			input: {
		...
		ListIdentityPools: {
			...
			output: {
				...
				members: {
					IdentityPools: {
						type: 'list',
						member: { type: 'structure', members: { IdentityPoolId: {}, IdentityPoolName: {} } }
					},
					NextToken: {}
				}
			}
		...
		ListTagsForResource: {
			input: { type: 'structure', required: ['ResourceArn'], members: { ResourceArn: {} } },
		...
		UnlinkIdentity: {
			input: {
				...
				members: { IdentityId: {}, Logins: { shape: 'S10' }, LoginsToRemove: { shape: 'Sw' } }
			},
			authtype: 'none'
		},
		UntagResource: {
	...
	shapes: {
		...
		Sb: {
			...
			member: {
				type: 'structure',
				members: { ProviderName: {}, ClientId: {}, ServerSideTokenCheck: { type: 'boolean' } }
			}
		},
		Sg: { type: 'list', member: {} },
...
(AWS.apiLoader.services.s3 = {}),
	...
	(_xamzrequire = (function e(t, r, i) {
		...
		for (var a = 'function' == typeof _xamzrequire && _xamzrequire, o = 0; o < i.length; o++)
			n(i[o]);
		return n;
	})(
		{
			113: [
				function (e, t, r) {
					var i = e('../core'),
						n = e('../signers/v4_credentials'),
						a = e('../config_regional_endpoint'),
						o = e('./s3util'),
						s = e('../region_config');
					e('../s3/managed_upload');
					var u = { completeMultipartUpload: !0, copyObject: !0, uploadPartCopy: !0 },
						c = ['AuthorizationHeaderMalformed', 'BadRequest', 'PermanentRedirect', 301];
					i.util.update(i.S3.prototype, {
						getSignatureVersion: function (e) {
							var t = this.api.signatureVersion,
								...
								i = this.config.signatureVersion,
								n = !!e && e.isPresigned();
							return r ? (r = 'v2' === r ? 's3' : r) : (!0 !== n ? (t = 'v4') : i && (t = i), t);
						},
						getSigningName: function (e) {
							if (e && 'writeGetObjectResponse' === e.operation) return 's3-object-lambda';
							var t = i.Service.prototype.getSigningName;
							return e && e._parsedArn && e._parsedArn.service
								? e._parsedArn.service
								: t.call(this);
						},
						getSignerClass: function (e) {
							var t = this.getSignatureVersion(e);
							return i.Signers.RequestSigner.getVersion(t);
						},
						validateService: function () {
							var e,
								t = [];
							if (
								...
								!this.config.endpoint &&
									this.config.s3BucketEndpoint &&
									t.push(
										'An endpoint must be provided when configuring `s3BucketEndpoint` to true.'
									),
								1 === t.length
									? (e = t[0])
									: t.length > 1 && (e = 'Multiple configuration errors:\n' + t.join('\n')),
								e)
							)
								throw i.util.error(new Error(), { name: 'InvalidEndpoint', message: e });
						},
						shouldDisableBodySigning: function (e) {
							var t = this.getSignerClass();
							return (
								!0 === this.config.s3DisableBodySigning &&
								t === i.Signers.V4 &&
								'https:' === e.httpRequest.endpoint.protocol
							);
						},
						setupRequestListeners: function (e) {
							if (
								...
								e.addListener('validate', this.optInUsEast1RegionalEndpoint, !0),
								e.removeListener('validate', i.EventListeners.Core.VALIDATE_REGION),
								...
								e.addListener('extractData', i.util.hoistPayloadMember),
								e.addListener('extractData', this.extractData),
								e.addListener('extractData', this.extractErrorFrom200Response),
								e.addListener('beforePresign', this.prepareSignedUrl),
								this.shouldDisableBodySigning(e) &&
									(e.removeListener('afterBuild', i.EventListeners.Core.COMPUTE_SHA256),
									e.addListener('afterBuild', this.disableBodySigning)),
								'createBucket' !== e.operation && o.isArnInParam(e, 'Bucket'))
							)
								return (
									(e._parsedArn = i.util.ARN.parse(e.params.Bucket)),
									e.removeListener('validate', this.validateBucketName),
									e.removeListener('build', this.populateURI),
									's3' === e._parsedArn.service
										? (e.addListener('validate', o.validateS3AccessPointArn),
										  e.addListener('validate', this.validateArnResourceType),
										  e.addListener('validate', this.validateArnRegion))
										: 's3-outposts' === e._parsedArn.service &&
										  (e.addListener('validate', o.validateOutpostsAccessPointArn),
										  e.addListener('validate', o.validateOutpostsArn),
										  e.addListener('validate', o.validateArnRegion)),
									e.addListener('validate', o.validateArnAccount),
									e.addListener('validate', o.validateArnService),
									e.addListener('build', this.populateUriFromAccessPointArn),
									void e.addListener('build', o.validatePopulateUriFromArn)
								);
							e.addListener('validate', this.validateBucketEndpoint),
								...
								i.util.isBrowser() && e.onAsync('retry', this.reqRegionForNetworkingError);
						},
						validateScheme: function (e) {
							var t = e.params,
								r = e.httpRequest.endpoint.protocol;
							if ((t.SSECustomerKey || t.CopySourceSSECustomerKey) && 'https:' !== r)
						...
						validateArnRegion: function (e) {
							o.validateArnRegion(e, { allowFipsEndpoint: !0 });
						},
						validateArnResourceType: function (e) {
							var t = e._parsedArn.resource;
							if (0 !== t.indexOf('accesspoint:') && 0 !== t.indexOf('accesspoint/'))
								throw i.util.error(new Error(), {
									code: 'InvalidARN',
						...
						validateBucketName: function (e) {
							var t = e.service,
								...
								n = e.params && e.params.Bucket,
								a = e.params && e.params.Key,
								o = n && n.indexOf('/');
							if (n && o >= 0)
								if ('string' == typeof a && o > 0) {
									e.params = i.util.copy(e.params);
									var s = n.substr(o + 1) || '';
									(e.params.Key = s + '/' + a), (e.params.Bucket = n.substr(0, o));
								} else if ('v4' === r) {
									var u = 'Bucket names cannot contain forward slashes. Bucket: ' + n;
									throw i.util.error(new Error(), { code: 'InvalidBucket', message: u });
								}
						},
						...
						optInUsEast1RegionalEndpoint: function (e) {
							var t = e.service,
								r = t.config;
							if (
								((r.s3UsEast1RegionalEndpoint = a(t._originalConfig, {
									env: 'AWS_S3_US_EAST_1_REGIONAL_ENDPOINT',
									sharedConfig: 's3_us_east_1_regional_endpoint',
									clientConfig: 's3UsEast1RegionalEndpoint'
								})),
								!(t._originalConfig || {}).endpoint &&
									'us-east-1' === e.httpRequest.region &&
									'regional' === r.s3UsEast1RegionalEndpoint &&
									e.httpRequest.endpoint.hostname.indexOf('s3.amazonaws.com') >= 0)
							) {
								var i = r.endpoint.indexOf('.amazonaws.com');
								(regionalEndpoint =
									r.endpoint.substring(0, i) + '.us-east-1' + r.endpoint.substring(i)),
									e.httpRequest.updateEndpoint(regionalEndpoint);
							}
						},
						populateURI: function (e) {
							var t = e.httpRequest,
								...
								i = e.service,
								n = t.endpoint;
							if (r && !i.pathStyleBucketName(r)) {
								i.config.useAccelerateEndpoint && i.isValidAccelerateOperation(e.operation)
									? i.config.useDualstackEndpoint
										? (n.hostname = r + '.s3-accelerate.dualstack.amazonaws.com')
										: (n.hostname = r + '.s3-accelerate.amazonaws.com')
									: i.config.s3BucketEndpoint || (n.hostname = r + '.' + n.hostname);
								var a = n.port;
								(n.host = 80 !== a && 443 !== a ? n.hostname + ':' + n.port : n.hostname),
									(t.virtualHostedBucket = r),
									i.removeVirtualHostedBucketFromPath(e);
							}
						},
						removeVirtualHostedBucketFromPath: function (e) {
							...
							if (r && t.path) {
								if (e.params && e.params.Key) {
									var n = '/' + i.util.uriEscapePath(e.params.Key);
									if (
										0 === t.path.indexOf(n) &&
										(t.path.length === n.length || '?' === t.path[n.length])
									)
										return;
								}
						...
						populateUriFromAccessPointArn: function (e) {
							var t = e._parsedArn,
								...
								a = r ? '.' + t.outpostId : '',
								o = r ? 's3-outposts' : 's3-accesspoint',
								u = !r && e.service.config.useFipsEndpoint ? '-fips' : '',
								c = !r && e.service.config.useDualstackEndpoint ? '.dualstack' : '',
								l = e.httpRequest.endpoint,
								d = s.getEndpointSuffix(t.region),
								p = e.service.config.s3UseArnRegion;
							if (
								((l.hostname = [
									t.accessPoint + '-' + t.accountId + a,
									o + u + c,
									p ? t.region : e.service.config.region,
									d
								].join('.')),
								n)
							) {
								var o = 's3-object-lambda',
									g = t.resource.split('/')[1],
									u = e.service.config.useFipsEndpoint ? '-fips' : '';
								l.hostname = [
									g + '-' + t.accountId,
									o + u,
									p ? t.region : e.service.config.region,
							...
							l.host = l.hostname;
							var f = i.util.uriEscape(e.params.Bucket),
								h = e.httpRequest.path;
							(e.httpRequest.path = h.replace(new RegExp('/' + f), '')),
								'/' !== e.httpRequest.path[0] && (e.httpRequest.path = '/' + e.httpRequest.path),
								(e.httpRequest.region = t.region);
						},
						addExpect100Continue: function (e) {
							var t = e.httpRequest.headers['Content-Length'];
							i.util.isNode() &&
								(t >= 1048576 || e.params.Body instanceof i.util.stream.Stream) &&
								(e.httpRequest.headers.Expect = '100-continue');
						},
						addContentType: function (e) {
							var t = e.httpRequest;
							if ('GET' === t.method || 'HEAD' === t.method)
								return void delete t.headers['Content-Type'];
							...
							if (i.util.isBrowser())
								if ('string' != typeof t.body || r.match(/;\s*charset=/)) {
									...
									t.headers['Content-Type'] = r.replace(/(;\s*charset=)(.+)$/, n);
								} else {
						...
						willComputeChecksums: function (e) {
							var t = e.service.api.operations[e.operation].input.members,
								...
								n =
									...
									!e.params.ContentMD5 &&
									r &&
									(i.util.Buffer.isBuffer(e.httpRequest.body) ||
										'string' == typeof e.httpRequest.body);
							return (
								!(!n || !e.service.shouldDisableBodySigning(e) || e.isPresigned()) ||
								!(!n || 's3' !== this.getSignatureVersion(e) || !e.isPresigned())
							);
						},
						computeContentMd5: function (e) {
							if (e.service.willComputeChecksums(e)) {
								var t = i.util.crypto.md5(e.httpRequest.body, 'base64');
						...
						computeSseCustomerKeyMd5: function (e) {
							...
							i.util.each(t, function (t, r) {
								if (e.params[t]) {
									var n = i.util.crypto.md5(e.params[t], 'base64');
									e.httpRequest.headers[r] = n;
								}
							});
						},
						pathStyleBucketName: function (e) {
							return (
								...
								(!this.config.s3BucketEndpoint &&
									(!o.dnsCompatibleBucketName(e) || !(!this.config.sslEnabled || !e.match(/\./))))
							);
						},
						extractErrorFrom200Response: function (e) {
							if (u[e.request.operation]) {
								var t = e.httpResponse;
								if (t.body && t.body.toString().match('<Error>')) {
									e.data = null;
									throw ((this.service ? this.service : this).extractError(e), e.error);
								}
								if (!t.body || !t.body.toString().match(/<[\w_]/))
									throw (
										((e.data = null),
										i.util.error(new Error(), {
											code: 'InternalError',
						...
						retryableError: function (e, t) {
							return (
								!(!u[t.operation] || 200 !== e.statusCode) ||
								((!t._requestRegionForBucket ||
									!t.service.bucketRegionCache[t._requestRegionForBucket]) &&
									(!(!e || 'RequestTimeout' !== e.code) ||
										(e && -1 != c.indexOf(e.code) && e.region && e.region != t.httpRequest.region
											? ((t.httpRequest.region = e.region),
											  301 === e.statusCode && t.service.updateReqBucketRegion(t),
											  !0)
											: i.Service.prototype.retryableError.call(this, e, t))))
							);
						},
						updateReqBucketRegion: function (e, t) {
							var r = e.httpRequest;
							if (
								('string' == typeof t && t.length && (r.region = t),
								r.endpoint.host.match(/s3(?!-accelerate).*\.amazonaws\.com$/))
							) {
								var n = e.service,
									a = n.config,
								...
								delete s.endpoint,
									(s.region = r.region),
									(r.endpoint = new i.S3(s).endpoint),
									n.populateURI(e),
									(a.s3BucketEndpoint = o),
									(r.headers.Host = r.endpoint.host),
									'validate' === e._asm.currentState &&
										(e.removeListener('build', n.populateURI),
										e.addListener('build', n.removeVirtualHostedBucketFromPath));
							}
						},
						extractData: function (e) {
							...
							var i = t.params.Bucket || null;
							if ('deleteBucket' !== t.operation || 'string' != typeof i || e.error) {
								var n = e.httpResponse.headers || {},
									a = n['x-amz-bucket-region'] || null;
								if (!a && 'createBucket' === t.operation && !e.error) {
									var o = t.params.CreateBucketConfiguration;
									a = o
										? 'EU' === o.LocationConstraint
											? 'eu-west-1'
								...
								a &&
									i &&
									a !== t.service.bucketRegionCache[i] &&
									(t.service.bucketRegionCache[i] = a);
							} else t.service.clearBucketRegionCache(i);
							t.service.extractRequestIds(e);
						},
						extractError: function (e) {
							var t = { 304: 'NotModified', 403: 'Forbidden', 400: 'BadRequest', 404: 'NotFound' },
								r = e.request,
								n = e.httpResponse.statusCode,
							...
							var l;
							if (t[n] && 0 === a.length)
								u && !s && (l = c[u] || null) !== r.httpRequest.region && (s = l),
									(e.error = i.util.error(new Error(), { code: t[n], message: null, region: s }));
							else {
								var d = new i.XML.Parser().parse(a.toString());
								d.Region && !s
									? ((s = d.Region), u && s !== c[u] && (c[u] = s))
									: !u || s || d.Region || ((l = c[u] || null) !== r.httpRequest.region && (s = l)),
						...
						requestBucketRegion: function (e, t) {
							var r = e.error,
								n = e.request,
								a = n.params.Bucket || null;
							if (
								!r ||
								!a ||
								r.region ||
								'listObjects' === n.operation ||
								(i.util.isNode() && 'headBucket' === n.operation) ||
								(400 === r.statusCode && 'headObject' !== n.operation) ||
								-1 === c.indexOf(r.code)
							)
								return t();
							var o = i.util.isNode() ? 'headBucket' : 'listObjects',
								s = { Bucket: a };
							'listObjects' === o && (s.MaxKeys = 0);
							var u = n.service[o](s);
							(u._requestRegionForBucket = a),
								u.send(function () {
									var e = n.service.bucketRegionCache[a] || null;
									(r.region = e), t();
								});
						},
						reqRegionForNetworkingError: function (e, t) {
							if (!i.util.isBrowser()) return t();
							var r = e.error,
								n = e.request,
								a = n.params.Bucket;
							if (!r || 'NetworkingError' !== r.code || !a || 'us-east-1' === n.httpRequest.region)
								return t();
							var s = n.service,
								u = s.bucketRegionCache,
								c = u[a] || null;
							if (c && c !== n.httpRequest.region) s.updateReqBucketRegion(n, c), t();
							else if (o.dnsCompatibleBucketName(a))
								if (n.httpRequest.virtualHostedBucket) {
									var l = s.listObjects({ Bucket: a, MaxKeys: 0 });
									s.updateReqBucketRegion(l, 'us-east-1'),
										(l._requestRegionForBucket = a),
										l.send(function () {
											var e = s.bucketRegionCache[a] || null;
											e && e !== n.httpRequest.region && s.updateReqBucketRegion(n, e), t();
										});
								} else t();
							else
								s.updateReqBucketRegion(n, 'us-east-1'),
									'us-east-1' !== u[a] && (u[a] = 'us-east-1'),
									t();
						},
						bucketRegionCache: {},
						...
						correctBucketRegionFromCache: function (e) {
							...
							if (t) {
								var r = e.service,
									i = e.httpRequest.region,
									n = r.bucketRegionCache[t];
								n && n !== i && r.updateReqBucketRegion(e, n);
							}
						},
						extractRequestIds: function (e) {
							...
							(e.extendedRequestId = t),
								(e.cfId = r),
								e.error &&
									((e.error.requestId = e.requestId || null),
									(e.error.extendedRequestId = t),
									(e.error.cfId = r));
						},
						getSignedUrl: function (e, t, r) {
							...
							if ('number' != typeof n)
								throw i.util.error(new Error(), {
									...
									message: 'The expiration must be a number, received ' + typeof n
								});
							delete t.Expires;
							var a = this.makeRequest(e, t);
							if (!r) return a.presign(n, r);
							i.util.defer(function () {
								a.presign(n, r);
							});
						},
						createPresignedPost: function (e, t) {
							function r() {
								return {
									url: i.util.urlFormat(u),
									fields: o.preparePostFields(
										s.credentials,
										s.region,
										a,
										e.Fields,
						...
						preparePostFields: function (e, t, r, a, o, s) {
							...
							(a = i.util.copy(a || {})), (o = (o || []).slice(0)), (s = s || 3600);
							var c = i.util.date.iso8601(u).replace(/[:\-]|\.\d{3}/g, ''),
								l = c.substr(0, 8),
								d = n.createScope(l, t, 's3'),
								p = e.accessKeyId + '/' + d;
							(a.bucket = r),
								(a['X-Amz-Algorithm'] = 'AWS4-HMAC-SHA256'),
								(a['X-Amz-Credential'] = p),
								(a['X-Amz-Date'] = c),
							...
							return (
								(a.Policy = this.preparePostPolicy(new Date(u.valueOf() + 1e3 * s), o)),
								(a['X-Amz-Signature'] = i.util.crypto.hmac(
									n.getSigningKey(e, l, t, 's3', !0),
									a.Policy,
									'hex'
								)),
								a
						...
						preparePostPolicy: function (e, t) {
							return i.util.base64.encode(
								JSON.stringify({ expiration: i.util.date.iso8601(e), conditions: t })
							);
						},
						prepareSignedUrl: function (e) {
							e.addListener('validate', e.service.noPresignedContentLength),
								...
								e.params.Body
									? e.addListener('afterBuild', i.EventListeners.Core.COMPUTE_SHA256)
									: e.removeListener('build', e.service.computeContentMd5);
						},
						disableBodySigning: function (e) {
							var t = e.httpRequest.headers;
							Object.prototype.hasOwnProperty.call(t, 'presigned-expires') ||
								(t['X-Amz-Content-Sha256'] = 'UNSIGNED-PAYLOAD');
						},
						noPresignedContentLength: function (e) {
							if (void 0 !== e.params.ContentLength)
								throw i.util.error(new Error(), {
						...
						createBucket: function (e, t) {
							...
							var r = this.endpoint.hostname,
								n = i.util.copy(e);
							return (
								r === this.api.globalEndpoint ||
									e.CreateBucketConfiguration ||
									(n.CreateBucketConfiguration = { LocationConstraint: this.config.region }),
								this.makeRequest('createBucket', n, t)
							);
						},
						writeGetObjectResponse: function (e, t) {
							var r = this.makeRequest('writeGetObjectResponse', i.util.copy(e), t),
								n = this.endpoint.hostname;
							return (
								(n =
									-1 !== n.indexOf(this.config.region)
										? n.replace('s3.', 's3-object-lambda.')
										: n.replace('s3.', 's3-object-lambda.' + this.config.region + '.')),
								(r.httpRequest.endpoint = new i.Endpoint(n, this.config)),
								r
							);
						},
						upload: function (e, t, r) {
							'function' == typeof t && void 0 === r && ((r = t), (t = null)),
								(t = t || {}),
								(t = i.util.merge(t || {}, { service: this, params: e }));
							var n = new i.S3.ManagedUpload(t);
							return 'function' == typeof r && n.send(r), n;
						}
					}),
						(i.S3.addPromisesToClass = function (e) {
							this.prototype.getSignedUrlPromise = i.util.promisifyMethod('getSignedUrl', e);
						}),
						(i.S3.deletePromisesFromClass = function () {
							delete this.prototype.getSignedUrlPromise;
						}),
						i.util.addPromises(i.S3);
				},
				{
					'../config_regional_endpoint': 43,
					'../core': 44,
					'../region_config': 88,
					'../s3/managed_upload': 93,
					'../signers/v4_credentials': 127,
					'./s3util': 115
				}
			],
			93: [
				function (e, t, r) {
					var i = e('../core'),
						n = i.util.string.byteLength,
						a = i.util.Buffer;
					(i.S3.ManagedUpload = i.util.inherit({
						constructor: function (e) {
							var t = this;
							i.SequentialExecutor.call(t),
								(t.body = null),
								(t.sliceFn = null),
								(t.callback = null),
								(t.parts = {}),
						...
						configure: function (e) {
							if (
								...
								e.queueSize && (this.queueSize = e.queueSize),
								e.partSize && (this.partSize = e.partSize),
								e.leavePartsOnError && (this.leavePartsOnError = !0),
								e.tags)
							) {
								if (!Array.isArray(e.tags))
									throw new Error(
										'Tags must be specified as an array; ' + typeof e.tags + ' provided.'
									);
								this.tags = e.tags;
							}
						...
						send: function (e) {
							...
							else if (i.util.isNode()) {
								var n = i.util.stream.Stream;
								t.body instanceof n &&
									((r = !1),
									(t.fillQueue = t.fillStream),
									(t.partBuffers = []),
									t.body
										.on('error', function (e) {
											t.cleanup(e);
										...
										.on('end', function () {
											(t.isDoneChunking = !0),
												...
												t.fillQueue.call(t),
												t.isDoneChunking &&
													t.totalPartNumbers >= 1 &&
													t.doneParts === t.numParts &&
													t.finishMultiPart();
										}));
							}
						...
						abort: function () {
							var e = this;
							!0 === e.isDoneChunking && 1 === e.totalPartNumbers && e.singlePart
								? e.singlePart.abort()
								: e.cleanup(
										i.util.error(new Error('Request aborted by user'), {
											code: 'RequestAbortedError',
											retryable: !1
										})
								  );
						...
						validateBody: function () {
							var e = this;
							if (((e.body = e.service.config.params.Body), 'string' == typeof e.body))
								e.body = i.util.buffer.toBuffer(e.body);
							else if (!e.body) throw new Error('params.Body is required');
							e.sliceFn = i.util.arraySliceFn(e.body);
						},
						bindServiceObject: function (e) {
							...
							if (t.service) {
								var r = t.service,
									n = i.util.copy(r.config);
								(n.signatureVersion = r.getSignatureVersion()),
									(t.service = new r.constructor.__super__(n)),
									(t.service.config.params = i.util.merge(t.service.config.params || {}, e)),
									Object.defineProperty(t.service, '_originalConfig', {
										get: function () {
							...
							} else t.service = new i.S3({ params: e });
						},
						adjustTotalBytes: function () {
							var e = this;
							try {
								e.totalBytes = n(e.body);
							} catch (e) {}
							if (e.totalBytes) {
						...
						fillBuffer: function () {
							var e = this,
								t = n(e.body);
							if (0 === t)
								return (e.isDoneChunking = !0), (e.numParts = 1), void e.nextChunk(e.body);
							for (; e.activeParts < e.queueSize && e.partPos < t; ) {
								var r = Math.min(e.partPos + e.partSize, t),
									i = e.sliceFn.call(e.body, e.partPos, r);
								(e.partPos += e.partSize),
									(n(i) < e.partSize || e.partPos === t) &&
										((e.isDoneChunking = !0), (e.numParts = e.totalPartNumbers + 1)),
									e.nextChunk(i);
							}
						},
						fillStream: function () {
							...
							if (!(e.activeParts >= e.queueSize)) {
								...
								if (
									(t &&
										(e.partBuffers.push(t),
										(e.partBufferLength += t.length),
										(e.totalChunkedBytes += t.length)),
									e.partBufferLength >= e.partSize)
								) {
									...
									if (((e.partBuffers = []), (e.partBufferLength = 0), r.length > e.partSize)) {
										var i = r.slice(e.partSize);
										e.partBuffers.push(i),
											(e.partBufferLength += i.length),
								...
								e.isDoneChunking &&
									!e.isDoneSending &&
									((r = 1 === e.partBuffers.length ? e.partBuffers[0] : a.concat(e.partBuffers)),
									(e.partBuffers = []),
									(e.partBufferLength = 0),
									(e.totalBytes = e.totalChunkedBytes),
									(e.isDoneSending = !0),
									(0 === e.numParts || r.length > 0) && (e.numParts++, e.nextChunk(r))),
									e.body.read(0);
							}
						},
						nextChunk: function (e) {
							...
							if (t.isDoneChunking && 1 === r) {
								var n = { Body: e };
								this.tags && (n.Tagging = this.getTaggingHeader());
								var a = t.service.putObject(n);
								return (
									(a._managedUpload = t),
							...
							if (t.service.config.params.ContentMD5) {
								var o = i.util.error(
									new Error('The Content-MD5 you specified is invalid for multi-part uploads.'),
									{ code: 'InvalidDigest', retryable: !1 }
								);
								return t.cleanup(o), null;
							}
							if (t.completeInfo[r] && null !== t.completeInfo[r].ETag) return null;
							t.activeParts++,
								t.service.config.params.UploadId
									? t.uploadPart(e, r)
									: t.multipartReq
									  ? t.queueChunks(e, r)
									  : ((t.multipartReq = t.service.createMultipartUpload()),
									    t.multipartReq.on('success', function (e) {
												(t.service.config.params.UploadId = e.data.UploadId),
													(t.multipartReq = null);
									    }),
									    t.queueChunks(e, r),
									    t.multipartReq.on('error', function (e) {
												t.cleanup(e);
									    }),
									    t.multipartReq.send());
						},
						getTaggingHeader: function () {
							for (var e = [], t = 0; t < this.tags.length; t++)
								e.push(
									i.util.uriEscape(this.tags[t].Key) + '=' + i.util.uriEscape(this.tags[t].Value)
								);
							return e.join('&');
						},
						uploadPart: function (e, t) {
							var r = this,
								n = { Body: e, ContentLength: i.util.string.byteLength(e), PartNumber: t },
								a = { ETag: null, PartNumber: t };
							r.completeInfo[t] = a;
							var o = r.service.uploadPart(n);
							(r.parts[t] = o),
								(o._lastUploadedBytes = 0),
								(o._managedUpload = r),
								o.on('httpUploadProgress', r.progress),
								o.send(function (e, o) {
									if ((delete r.parts[n.PartNumber], r.activeParts--, !(e || (o && o.ETag)))) {
										var s = 'No access to ETag property on response.';
										i.util.isBrowser() && (s += ' Check CORS configuration to expose ETag header.'),
											(e = i.util.error(new Error(s), { code: 'ETagMissing', retryable: !1 }));
									}
									return e
										? r.cleanup(e)
										: r.completeInfo[t] && null !== r.completeInfo[t].ETag
										  ? null
										  : ((a.ETag = o.ETag),
										    r.doneParts++,
										    void (r.isDoneChunking && r.doneParts === r.totalPartNumbers
													? r.finishMultiPart()
													: r.fillQueue.call(r)));
								});
						},
						...
						cleanup: function (e) {
							var t = this;
							t.failed ||
								('function' == typeof t.body.removeAllListeners &&
									'function' == typeof t.body.resume &&
									(t.body.removeAllListeners('readable'),
									t.body.removeAllListeners('end'),
									t.body.resume()),
								t.multipartReq &&
									(t.multipartReq.removeAllListeners('success'),
									t.multipartReq.removeAllListeners('error'),
									t.multipartReq.removeAllListeners('complete'),
									delete t.multipartReq),
								t.service.config.params.UploadId && !t.leavePartsOnError
									? t.service.abortMultipartUpload().send()
									: t.leavePartsOnError && (t.isDoneChunking = !1),
								i.util.each(t.parts, function (e, t) {
									t.removeAllListeners('complete'), t.abort();
								}),
								(t.activeParts = 0),
								(t.partPos = 0),
								(t.numParts = 0),
								(t.totalPartNumbers = 0),
								(t.parts = {}),
								(t.failed = !0),
								t.callback(e));
						},
						finishMultiPart: function () {
							var e = this,
								t = { MultipartUpload: { Parts: e.completeInfo.slice(1) } };
							e.service.completeMultipartUpload(t, function (t, r) {
								if (t) return e.cleanup(t);
								if (
									(r &&
										'string' == typeof r.Location &&
										(r.Location = r.Location.replace(/%2F/g, '/')),
									Array.isArray(e.tags))
								) {
									for (var i = 0; i < e.tags.length; i++) e.tags[i].Value = String(e.tags[i].Value);
									e.service.putObjectTagging({ Tagging: { TagSet: e.tags } }, function (t, i) {
						...
						finishSinglePart: function (e, t) {
							var r = this.request._managedUpload,
								i = this.request.httpRequest,
								n = i.endpoint;
							if (e) return r.callback(e);
							(t.Location = [n.protocol, '//', n.host, i.path].join('')),
						...
						progress: function (e) {
							...
							'putObject' === this.operation
								? ((e.part = 1), (e.key = this.params.Key))
								: ((t.totalUploadedBytes += e.loaded - this._lastUploadedBytes),
								  (this._lastUploadedBytes = e.loaded),
								  (e = {
						...
						i.util.mixin(i.S3.ManagedUpload, i.SequentialExecutor),
						(i.S3.ManagedUpload.addPromisesToClass = function (e) {
							this.prototype.promise = i.util.promisifyMethod('send', e);
						}),
						(i.S3.ManagedUpload.deletePromisesFromClass = function () {
							delete this.prototype.promise;
						}),
						i.util.addPromises(i.S3.ManagedUpload),
						(t.exports = i.S3.ManagedUpload);
				},
				{ '../core': 44 }
			]
		},
...
AWS.apiLoader.services.s3['2006-03-01'] = {
	...
	operations: {
		AbortMultipartUpload: {
			http: { method: 'DELETE', requestUri: '/{Bucket}/{Key+}', responseCode: 204 },
			input: {
				type: 'structure',
				...
				members: {
					...
					UploadId: { location: 'querystring', locationName: 'uploadId' },
					RequestPayer: { location: 'header', locationName: 'x-amz-request-payer' },
					ExpectedBucketOwner: { location: 'header', locationName: 'x-amz-expected-bucket-owner' }
				}
			},
			output: {
				type: 'structure',
				members: { RequestCharged: { location: 'header', locationName: 'x-amz-request-charged' } }
			}
		},
		CompleteMultipartUpload: {
			http: { requestUri: '/{Bucket}/{Key+}' },
			input: {
				type: 'structure',
				required: ['Bucket', 'Key', 'UploadId'],
				members: {
					...
					UploadId: { location: 'querystring', locationName: 'uploadId' },
					ChecksumCRC32: { location: 'header', locationName: 'x-amz-checksum-crc32' },
					ChecksumCRC32C: { location: 'header', locationName: 'x-amz-checksum-crc32c' },
					ChecksumSHA1: { location: 'header', locationName: 'x-amz-checksum-sha1' },
					ChecksumSHA256: { location: 'header', locationName: 'x-amz-checksum-sha256' },
					RequestPayer: { location: 'header', locationName: 'x-amz-request-payer' },
					ExpectedBucketOwner: { location: 'header', locationName: 'x-amz-expected-bucket-owner' },
			...
			output: {
				...
				members: {
					...
					Bucket: {},
					Key: {},
					Expiration: { location: 'header', locationName: 'x-amz-expiration' },
					ETag: {},
					ChecksumCRC32: {},
					ChecksumCRC32C: {},
					ChecksumSHA1: {},
					...
					VersionId: { location: 'header', locationName: 'x-amz-version-id' },
					SSEKMSKeyId: {
						shape: 'Sr',
						location: 'header',
					...
					RequestCharged: { location: 'header', locationName: 'x-amz-request-charged' }
				}
			}
		},
		CopyObject: {
			...
			input: {
				...
				members: {
					...
					Bucket: { location: 'uri', locationName: 'Bucket' },
					CacheControl: { location: 'header', locationName: 'Cache-Control' },
					ChecksumAlgorithm: { location: 'header', locationName: 'x-amz-checksum-algorithm' },
					ContentDisposition: { location: 'header', locationName: 'Content-Disposition' },
					ContentEncoding: { location: 'header', locationName: 'Content-Encoding' },
					ContentLanguage: { location: 'header', locationName: 'Content-Language' },
					ContentType: { location: 'header', locationName: 'Content-Type' },
					CopySource: { location: 'header', locationName: 'x-amz-copy-source' },
					CopySourceIfMatch: { location: 'header', locationName: 'x-amz-copy-source-if-match' },
					...
					Expires: { location: 'header', locationName: 'Expires', type: 'timestamp' },
					GrantFullControl: { location: 'header', locationName: 'x-amz-grant-full-control' },
					GrantRead: { location: 'header', locationName: 'x-amz-grant-read' },
					GrantReadACP: { location: 'header', locationName: 'x-amz-grant-read-acp' },
					GrantWriteACP: { location: 'header', locationName: 'x-amz-grant-write-acp' },
					Key: { location: 'uri', locationName: 'Key' },
					Metadata: { shape: 'S1b', location: 'headers', locationName: 'x-amz-meta-' },
					MetadataDirective: { location: 'header', locationName: 'x-amz-metadata-directive' },
					TaggingDirective: { location: 'header', locationName: 'x-amz-tagging-directive' },
					ServerSideEncryption: {
						location: 'header',
						locationName: 'x-amz-server-side-encryption'
					},
					StorageClass: { location: 'header', locationName: 'x-amz-storage-class' },
					...
					RequestPayer: { location: 'header', locationName: 'x-amz-request-payer' },
					Tagging: { location: 'header', locationName: 'x-amz-tagging' },
					ObjectLockMode: { location: 'header', locationName: 'x-amz-object-lock-mode' },
			...
			output: {
				...
				members: {
					...
					Expiration: { location: 'header', locationName: 'x-amz-expiration' },
					CopySourceVersionId: { location: 'header', locationName: 'x-amz-copy-source-version-id' },
					VersionId: { location: 'header', locationName: 'x-amz-version-id' },
					ServerSideEncryption: {
						location: 'header',
						locationName: 'x-amz-server-side-encryption'
			...
			input: {
				...
				members: {
					...
					CreateBucketConfiguration: {
						...
						xmlNamespace: { uri: 'http://s3.amazonaws.com/doc/2006-03-01/' },
						type: 'structure',
						members: { LocationConstraint: {} }
					},
					GrantFullControl: { location: 'header', locationName: 'x-amz-grant-full-control' },
					GrantRead: { location: 'header', locationName: 'x-amz-grant-read' },
					GrantReadACP: { location: 'header', locationName: 'x-amz-grant-read-acp' },
					GrantWrite: { location: 'header', locationName: 'x-amz-grant-write' },
					GrantWriteACP: { location: 'header', locationName: 'x-amz-grant-write-acp' },
					...
					ObjectOwnership: { location: 'header', locationName: 'x-amz-object-ownership' }
				},
				payload: 'CreateBucketConfiguration'
			},
			output: {
				type: 'structure',
				members: { Location: { location: 'header', locationName: 'Location' } }
			},
			alias: 'PutBucket'
		},
		CreateMultipartUpload: {
			http: { requestUri: '/{Bucket}/{Key+}?uploads' },
			input: {
				type: 'structure',
				required: ['Bucket', 'Key'],
				members: {
			...
			output: {
				type: 'structure',
				members: {
					AbortDate: { location: 'header', locationName: 'x-amz-abort-date', type: 'timestamp' },
					AbortRuleId: { location: 'header', locationName: 'x-amz-abort-rule-id' },
		...
		DeleteBucket: {
			http: { method: 'DELETE', requestUri: '/{Bucket}', responseCode: 204 },
			input: {
				type: 'structure',
				required: ['Bucket'],
				members: {
		...
		DeleteBucketAnalyticsConfiguration: {
			http: { method: 'DELETE', requestUri: '/{Bucket}?analytics', responseCode: 204 },
			input: {
				type: 'structure',
				required: ['Bucket', 'Id'],
				members: {
					Bucket: { location: 'uri', locationName: 'Bucket' },
					Id: { location: 'querystring', locationName: 'id' },
					ExpectedBucketOwner: { location: 'header', locationName: 'x-amz-expected-bucket-owner' }
				}
			}
		},
		DeleteBucketCors: {
			http: { method: 'DELETE', requestUri: '/{Bucket}?cors', responseCode: 204 },
			input: {
				type: 'structure',
				required: ['Bucket'],
				members: {
		...
		DeleteBucketEncryption: {
			http: { method: 'DELETE', requestUri: '/{Bucket}?encryption', responseCode: 204 },
			input: {
				type: 'structure',
				required: ['Bucket'],
				members: {
		...
		DeleteBucketIntelligentTieringConfiguration: {
			http: { method: 'DELETE', requestUri: '/{Bucket}?intelligent-tiering', responseCode: 204 },
			input: {
				type: 'structure',
				required: ['Bucket', 'Id'],
				members: {
		...
		DeleteBucketInventoryConfiguration: {
			http: { method: 'DELETE', requestUri: '/{Bucket}?inventory', responseCode: 204 },
			input: {
				type: 'structure',
				required: ['Bucket', 'Id'],
				members: {
		...
		DeleteBucketLifecycle: {
			http: { method: 'DELETE', requestUri: '/{Bucket}?lifecycle', responseCode: 204 },
			input: {
				type: 'structure',
				required: ['Bucket'],
				members: {
		...
		DeleteBucketMetricsConfiguration: {
			http: { method: 'DELETE', requestUri: '/{Bucket}?metrics', responseCode: 204 },
			input: {
				type: 'structure',
				required: ['Bucket', 'Id'],
				members: {
		...
		DeleteBucketOwnershipControls: {
			http: { method: 'DELETE', requestUri: '/{Bucket}?ownershipControls', responseCode: 204 },
			input: {
				type: 'structure',
				required: ['Bucket'],
				members: {
		...
		DeleteBucketPolicy: {
			http: { method: 'DELETE', requestUri: '/{Bucket}?policy', responseCode: 204 },
			input: {
				type: 'structure',
				required: ['Bucket'],
				members: {
		...
		DeleteBucketReplication: {
			http: { method: 'DELETE', requestUri: '/{Bucket}?replication', responseCode: 204 },
			input: {
				type: 'structure',
				required: ['Bucket'],
				members: {
		...
		DeleteBucketTagging: {
			http: { method: 'DELETE', requestUri: '/{Bucket}?tagging', responseCode: 204 },
			input: {
				type: 'structure',
				required: ['Bucket'],
				members: {
		...
		DeleteBucketWebsite: {
			http: { method: 'DELETE', requestUri: '/{Bucket}?website', responseCode: 204 },
			input: {
				type: 'structure',
				required: ['Bucket'],
				members: {
		...
		DeleteObject: {
			...
			input: {
				...
				members: {
					Bucket: { location: 'uri', locationName: 'Bucket' },
					Key: { location: 'uri', locationName: 'Key' },
					MFA: { location: 'header', locationName: 'x-amz-mfa' },
					VersionId: { location: 'querystring', locationName: 'versionId' },
					RequestPayer: { location: 'header', locationName: 'x-amz-request-payer' },
		...
		DeleteObjectTagging: {
			http: { method: 'DELETE', requestUri: '/{Bucket}/{Key+}?tagging', responseCode: 204 },
			input: {
				type: 'structure',
				required: ['Bucket', 'Key'],
				members: {
			...
			output: {
				type: 'structure',
				members: { VersionId: { location: 'header', locationName: 'x-amz-version-id' } }
			}
		},
		DeleteObjects: {
			http: { requestUri: '/{Bucket}?delete' },
			input: {
				type: 'structure',
				...
				members: {
					...
					ExpectedBucketOwner: { location: 'header', locationName: 'x-amz-expected-bucket-owner' },
					ChecksumAlgorithm: { location: 'header', locationName: 'x-amz-sdk-checksum-algorithm' }
				},
				payload: 'Delete'
			},
			output: {
				...
				members: {
					...
					Errors: {
						...
						member: {
							type: 'structure',
							members: { Key: {}, VersionId: {}, Code: {}, Message: {} }
						},
						flattened: !0
					}
				}
			...
			httpChecksum: { requestAlgorithmMember: 'ChecksumAlgorithm', requestChecksumRequired: !0 }
		},
		DeletePublicAccessBlock: {
			http: { method: 'DELETE', requestUri: '/{Bucket}?publicAccessBlock', responseCode: 204 },
			input: {
				type: 'structure',
				required: ['Bucket'],
				members: {
		...
		GetBucketAccelerateConfiguration: {
			http: { method: 'GET', requestUri: '/{Bucket}?accelerate' },
			input: {
				type: 'structure',
				required: ['Bucket'],
				members: {
		...
		GetBucketAcl: {
			http: { method: 'GET', requestUri: '/{Bucket}?acl' },
			input: {
				type: 'structure',
				required: ['Bucket'],
				members: {
			...
			output: {
				...
				members: {
					Owner: { shape: 'S3d' },
					Grants: { shape: 'S3g', locationName: 'AccessControlList' }
				}
			}
		},
		GetBucketAnalyticsConfiguration: {
			http: { method: 'GET', requestUri: '/{Bucket}?analytics' },
			input: {
				type: 'structure',
				required: ['Bucket', 'Id'],
				members: {
			...
			output: {
				type: 'structure',
				members: { AnalyticsConfiguration: { shape: 'S3p' } },
				payload: 'AnalyticsConfiguration'
			}
		},
		GetBucketCors: {
			http: { method: 'GET', requestUri: '/{Bucket}?cors' },
			input: {
				type: 'structure',
				required: ['Bucket'],
				members: {
			...
			output: {
				type: 'structure',
				members: { CORSRules: { shape: 'S44', locationName: 'CORSRule' } }
			}
		},
		GetBucketEncryption: {
			http: { method: 'GET', requestUri: '/{Bucket}?encryption' },
			input: {
				type: 'structure',
				required: ['Bucket'],
				members: {
			...
			output: {
				type: 'structure',
				members: { ServerSideEncryptionConfiguration: { shape: 'S4h' } },
				payload: 'ServerSideEncryptionConfiguration'
			}
		},
		GetBucketIntelligentTieringConfiguration: {
			http: { method: 'GET', requestUri: '/{Bucket}?intelligent-tiering' },
			input: {
				type: 'structure',
				required: ['Bucket', 'Id'],
				members: {
			...
			output: {
				type: 'structure',
				members: { IntelligentTieringConfiguration: { shape: 'S4n' } },
				payload: 'IntelligentTieringConfiguration'
			}
		},
		GetBucketInventoryConfiguration: {
			http: { method: 'GET', requestUri: '/{Bucket}?inventory' },
			input: {
				type: 'structure',
				required: ['Bucket', 'Id'],
				members: {
			...
			output: {
				type: 'structure',
				members: { InventoryConfiguration: { shape: 'S4x' } },
				payload: 'InventoryConfiguration'
			}
		},
		GetBucketLifecycle: {
			http: { method: 'GET', requestUri: '/{Bucket}?lifecycle' },
			input: {
				type: 'structure',
				required: ['Bucket'],
				members: {
			...
			output: { type: 'structure', members: { Rules: { shape: 'S5d', locationName: 'Rule' } } },
			deprecated: !0
		},
		GetBucketLifecycleConfiguration: {
			...
			output: { type: 'structure', members: { Rules: { shape: 'S5t', locationName: 'Rule' } } }
		},
		GetBucketLocation: {
			http: { method: 'GET', requestUri: '/{Bucket}?location' },
			input: {
				type: 'structure',
				required: ['Bucket'],
				members: {
			...
			output: { type: 'structure', members: { LocationConstraint: {} } }
		},
		GetBucketLogging: {
			http: { method: 'GET', requestUri: '/{Bucket}?logging' },
			input: {
				type: 'structure',
				required: ['Bucket'],
				members: {
			...
			output: { type: 'structure', members: { LoggingEnabled: { shape: 'S65' } } }
		},
		GetBucketMetricsConfiguration: {
			http: { method: 'GET', requestUri: '/{Bucket}?metrics' },
			input: {
				type: 'structure',
				required: ['Bucket', 'Id'],
				members: {
			...
			output: {
				type: 'structure',
				members: { MetricsConfiguration: { shape: 'S6d' } },
				payload: 'MetricsConfiguration'
			}
		},
		GetBucketNotification: {
			http: { method: 'GET', requestUri: '/{Bucket}?notification' },
			input: { shape: 'S6h' },
			output: { shape: 'S6i' },
			deprecated: !0
		},
		...
		GetBucketOwnershipControls: {
			http: { method: 'GET', requestUri: '/{Bucket}?ownershipControls' },
			input: {
				type: 'structure',
				required: ['Bucket'],
				members: {
			...
			output: {
				type: 'structure',
				members: { OwnershipControls: { shape: 'S7a' } },
				payload: 'OwnershipControls'
			}
		},
		GetBucketPolicy: {
			http: { method: 'GET', requestUri: '/{Bucket}?policy' },
			input: {
				type: 'structure',
				required: ['Bucket'],
				members: {
			...
			output: { type: 'structure', members: { Policy: {} }, payload: 'Policy' }
		},
		GetBucketPolicyStatus: {
			http: { method: 'GET', requestUri: '/{Bucket}?policyStatus' },
			input: {
				type: 'structure',
				required: ['Bucket'],
				members: {
			...
			output: {
				...
				members: {
					PolicyStatus: {
						type: 'structure',
						members: { IsPublic: { locationName: 'IsPublic', type: 'boolean' } }
					}
				},
		...
		GetBucketReplication: {
			http: { method: 'GET', requestUri: '/{Bucket}?replication' },
			input: {
				type: 'structure',
				required: ['Bucket'],
				members: {
			...
			output: {
				type: 'structure',
				members: { ReplicationConfiguration: { shape: 'S7m' } },
				payload: 'ReplicationConfiguration'
			}
		},
		GetBucketRequestPayment: {
			http: { method: 'GET', requestUri: '/{Bucket}?requestPayment' },
			input: {
				type: 'structure',
				required: ['Bucket'],
				members: {
			...
			output: { type: 'structure', members: { Payer: {} } }
		},
		GetBucketTagging: {
			http: { method: 'GET', requestUri: '/{Bucket}?tagging' },
			input: {
				type: 'structure',
				required: ['Bucket'],
				members: {
			...
			output: { type: 'structure', required: ['TagSet'], members: { TagSet: { shape: 'S3v' } } }
		},
		GetBucketVersioning: {
			http: { method: 'GET', requestUri: '/{Bucket}?versioning' },
			input: {
				type: 'structure',
				required: ['Bucket'],
				members: {
			...
			output: {
				type: 'structure',
				members: { Status: {}, MFADelete: { locationName: 'MfaDelete' } }
			}
		},
		GetBucketWebsite: {
			http: { method: 'GET', requestUri: '/{Bucket}?website' },
			input: {
				type: 'structure',
				required: ['Bucket'],
				members: {
			...
			output: {
				type: 'structure',
				members: {
					RedirectAllRequestsTo: { shape: 'S8p' },
					IndexDocument: { shape: 'S8s' },
					ErrorDocument: { shape: 'S8u' },
					RoutingRules: { shape: 'S8v' }
				}
			}
		},
		GetObject: {
			...
			input: {
				...
				members: {
					...
					IfNoneMatch: { location: 'header', locationName: 'If-None-Match' },
					IfUnmodifiedSince: {
						location: 'header',
					...
					ResponseCacheControl: { location: 'querystring', locationName: 'response-cache-control' },
					...
					ResponseContentType: { location: 'querystring', locationName: 'response-content-type' },
					ResponseExpires: {
						location: 'querystring',
					...
					ExpectedBucketOwner: { location: 'header', locationName: 'x-amz-expected-bucket-owner' },
					ChecksumMode: { location: 'header', locationName: 'x-amz-checksum-mode' }
				}
			},
			output: {
				type: 'structure',
				members: {
					Body: { streaming: !0, type: 'blob' },
					DeleteMarker: {
						location: 'header',
						locationName: 'x-amz-delete-marker',
						type: 'boolean'
					},
					AcceptRanges: { location: 'header', locationName: 'accept-ranges' },
					Expiration: { location: 'header', locationName: 'x-amz-expiration' },
					Restore: { location: 'header', locationName: 'x-amz-restore' },
					LastModified: { location: 'header', locationName: 'Last-Modified', type: 'timestamp' },
					ContentLength: { location: 'header', locationName: 'Content-Length', type: 'long' },
					ETag: { location: 'header', locationName: 'ETag' },
					ChecksumCRC32: { location: 'header', locationName: 'x-amz-checksum-crc32' },
					ChecksumCRC32C: { location: 'header', locationName: 'x-amz-checksum-crc32c' },
					ChecksumSHA1: { location: 'header', locationName: 'x-amz-checksum-sha1' },
					ChecksumSHA256: { location: 'header', locationName: 'x-amz-checksum-sha256' },
					MissingMeta: { location: 'header', locationName: 'x-amz-missing-meta', type: 'integer' },
					VersionId: { location: 'header', locationName: 'x-amz-version-id' },
					CacheControl: { location: 'header', locationName: 'Cache-Control' },
					ContentDisposition: { location: 'header', locationName: 'Content-Disposition' },
					ContentEncoding: { location: 'header', locationName: 'Content-Encoding' },
					ContentLanguage: { location: 'header', locationName: 'Content-Language' },
					ContentRange: { location: 'header', locationName: 'Content-Range' },
					ContentType: { location: 'header', locationName: 'Content-Type' },
					Expires: { location: 'header', locationName: 'Expires', type: 'timestamp' },
					WebsiteRedirectLocation: {
						location: 'header',
					...
					StorageClass: { location: 'header', locationName: 'x-amz-storage-class' },
					RequestCharged: { location: 'header', locationName: 'x-amz-request-charged' },
					ReplicationStatus: { location: 'header', locationName: 'x-amz-replication-status' },
					PartsCount: { location: 'header', locationName: 'x-amz-mp-parts-count', type: 'integer' },
					TagCount: { location: 'header', locationName: 'x-amz-tagging-count', type: 'integer' },
					ObjectLockMode: { location: 'header', locationName: 'x-amz-object-lock-mode' },
					ObjectLockRetainUntilDate: {
						shape: 'S1o',
						location: 'header',
		...
		GetObjectAcl: {
			http: { method: 'GET', requestUri: '/{Bucket}/{Key+}?acl' },
			input: {
				type: 'structure',
				required: ['Bucket', 'Key'],
				members: {
		...
		GetObjectAttributes: {
			http: { method: 'GET', requestUri: '/{Bucket}/{Key+}?attributes' },
			input: {
				type: 'structure',
				...
				members: {
					...
					Key: { location: 'uri', locationName: 'Key' },
					VersionId: { location: 'querystring', locationName: 'versionId' },
					MaxParts: { location: 'header', locationName: 'x-amz-max-parts', type: 'integer' },
					PartNumberMarker: {
						location: 'header',
			...
			output: {
				...
				members: {
					...
					Checksum: {
						type: 'structure',
						members: { ChecksumCRC32: {}, ChecksumCRC32C: {}, ChecksumSHA1: {}, ChecksumSHA256: {} }
					},
					ObjectParts: {
						type: 'structure',
						members: {
							TotalPartsCount: { locationName: 'PartsCount', type: 'integer' },
		...
		GetObjectLegalHold: {
			http: { method: 'GET', requestUri: '/{Bucket}/{Key+}?legal-hold' },
			input: {
				type: 'structure',
				required: ['Bucket', 'Key'],
				members: {
			...
			output: { type: 'structure', members: { LegalHold: { shape: 'Sa9' } }, payload: 'LegalHold' }
		},
		GetObjectLockConfiguration: {
			http: { method: 'GET', requestUri: '/{Bucket}?object-lock' },
			input: {
				type: 'structure',
				required: ['Bucket'],
				members: {
			...
			output: {
				type: 'structure',
				members: { ObjectLockConfiguration: { shape: 'Sac' } },
				payload: 'ObjectLockConfiguration'
			}
		},
		GetObjectRetention: {
			http: { method: 'GET', requestUri: '/{Bucket}/{Key+}?retention' },
			input: {
				type: 'structure',
				required: ['Bucket', 'Key'],
				members: {
			...
			output: { type: 'structure', members: { Retention: { shape: 'Sak' } }, payload: 'Retention' }
		},
		GetObjectTagging: {
			http: { method: 'GET', requestUri: '/{Bucket}/{Key+}?tagging' },
			input: {
				type: 'structure',
				required: ['Bucket', 'Key'],
				members: {
		...
		GetPublicAccessBlock: {
			http: { method: 'GET', requestUri: '/{Bucket}?publicAccessBlock' },
			input: {
				type: 'structure',
				required: ['Bucket'],
				members: {
			...
			output: {
				type: 'structure',
				members: { PublicAccessBlockConfiguration: { shape: 'Sar' } },
		...
		HeadObject: {
			http: { method: 'HEAD', requestUri: '/{Bucket}/{Key+}' },
			input: {
				type: 'structure',
				required: ['Bucket', 'Key'],
				members: {
			...
			output: {
				...
				members: {
					...
					Expiration: { location: 'header', locationName: 'x-amz-expiration' },
					Restore: { location: 'header', locationName: 'x-amz-restore' },
					ArchiveStatus: { location: 'header', locationName: 'x-amz-archive-status' },
					LastModified: { location: 'header', locationName: 'Last-Modified', type: 'timestamp' },
					ContentLength: { location: 'header', locationName: 'Content-Length', type: 'long' },
					ChecksumCRC32: { location: 'header', locationName: 'x-amz-checksum-crc32' },
					ChecksumCRC32C: { location: 'header', locationName: 'x-amz-checksum-crc32c' },
		...
		ListBucketAnalyticsConfigurations: {
			...
			input: {
				...
				members: {
					Bucket: { location: 'uri', locationName: 'Bucket' },
					ContinuationToken: { location: 'querystring', locationName: 'continuation-token' },
					ExpectedBucketOwner: { location: 'header', locationName: 'x-amz-expected-bucket-owner' }
				}
			},
			output: {
				...
				members: {
					Buckets: {
						...
						member: {
							locationName: 'Bucket',
							type: 'structure',
							members: { Name: {}, CreationDate: { type: 'timestamp' } }
						}
					},
					Owner: { shape: 'S3d' }
				}
		...
		ListMultipartUploads: {
			http: { method: 'GET', requestUri: '/{Bucket}?uploads' },
			input: {
				type: 'structure',
				required: ['Bucket'],
				members: {
					Bucket: { location: 'uri', locationName: 'Bucket' },
					Delimiter: { location: 'querystring', locationName: 'delimiter' },
					EncodingType: { location: 'querystring', locationName: 'encoding-type' },
					KeyMarker: { location: 'querystring', locationName: 'key-marker' },
					MaxUploads: { location: 'querystring', locationName: 'max-uploads', type: 'integer' },
					Prefix: { location: 'querystring', locationName: 'prefix' },
					UploadIdMarker: { location: 'querystring', locationName: 'upload-id-marker' },
					ExpectedBucketOwner: { location: 'header', locationName: 'x-amz-expected-bucket-owner' }
				}
			},
			output: {
				...
				members: {
					...
					CommonPrefixes: { shape: 'Sbs' },
					EncodingType: {}
				}
			}
		},
		ListObjectVersions: {
			http: { method: 'GET', requestUri: '/{Bucket}?versions' },
			input: {
				type: 'structure',
				required: ['Bucket'],
				members: {
					...
					EncodingType: { location: 'querystring', locationName: 'encoding-type' },
					KeyMarker: { location: 'querystring', locationName: 'key-marker' },
					MaxKeys: { location: 'querystring', locationName: 'max-keys', type: 'integer' },
					Prefix: { location: 'querystring', locationName: 'prefix' },
					VersionIdMarker: { location: 'querystring', locationName: 'version-id-marker' },
					ExpectedBucketOwner: { location: 'header', locationName: 'x-amz-expected-bucket-owner' }
				}
			},
			output: {
		...
		ListObjectsV2: {
			...
			input: {
				...
				members: {
					...
					Prefix: { location: 'querystring', locationName: 'prefix' },
					ContinuationToken: { location: 'querystring', locationName: 'continuation-token' },
					FetchOwner: { location: 'querystring', locationName: 'fetch-owner', type: 'boolean' },
					StartAfter: { location: 'querystring', locationName: 'start-after' },
					RequestPayer: { location: 'header', locationName: 'x-amz-request-payer' },
					ExpectedBucketOwner: { location: 'header', locationName: 'x-amz-expected-bucket-owner' }
				}
			},
		...
		ListParts: {
			...
			input: {
				...
				members: {
					Bucket: { location: 'uri', locationName: 'Bucket' },
					Key: { location: 'uri', locationName: 'Key' },
					MaxParts: { location: 'querystring', locationName: 'max-parts', type: 'integer' },
					PartNumberMarker: {
						location: 'querystring',
		...
		PutBucketAccelerateConfiguration: {
			http: { method: 'PUT', requestUri: '/{Bucket}?accelerate' },
			input: {
				type: 'structure',
			...
			httpChecksum: { requestAlgorithmMember: 'ChecksumAlgorithm', requestChecksumRequired: !1 }
		},
		PutBucketAcl: {
			http: { method: 'PUT', requestUri: '/{Bucket}?acl' },
			input: {
				type: 'structure',
				required: ['Bucket'],
				members: {
					...
					Bucket: { location: 'uri', locationName: 'Bucket' },
					ContentMD5: { location: 'header', locationName: 'Content-MD5' },
					ChecksumAlgorithm: { location: 'header', locationName: 'x-amz-sdk-checksum-algorithm' },
					GrantFullControl: { location: 'header', locationName: 'x-amz-grant-full-control' },
					GrantRead: { location: 'header', locationName: 'x-amz-grant-read' },
					GrantReadACP: { location: 'header', locationName: 'x-amz-grant-read-acp' },
		...
		PutBucketAnalyticsConfiguration: {
			http: { method: 'PUT', requestUri: '/{Bucket}?analytics' },
			input: {
				type: 'structure',
		...
		PutBucketCors: {
			http: { method: 'PUT', requestUri: '/{Bucket}?cors' },
			input: {
				type: 'structure',
		...
		PutBucketEncryption: {
			http: { method: 'PUT', requestUri: '/{Bucket}?encryption' },
			input: {
				type: 'structure',
		...
		PutBucketIntelligentTieringConfiguration: {
			http: { method: 'PUT', requestUri: '/{Bucket}?intelligent-tiering' },
			input: {
				type: 'structure',
		...
		PutBucketInventoryConfiguration: {
			http: { method: 'PUT', requestUri: '/{Bucket}?inventory' },
			input: {
				type: 'structure',
		...
		PutBucketLifecycle: {
			http: { method: 'PUT', requestUri: '/{Bucket}?lifecycle' },
			input: {
				type: 'structure',
				required: ['Bucket'],
				members: {
					...
					LifecycleConfiguration: {
						...
						type: 'structure',
						required: ['Rules'],
						members: { Rules: { shape: 'S5d', locationName: 'Rule' } }
					},
					ExpectedBucketOwner: { location: 'header', locationName: 'x-amz-expected-bucket-owner' }
				},
			...
			input: {
				...
				members: {
					...
					LifecycleConfiguration: {
						...
						type: 'structure',
						required: ['Rules'],
						members: { Rules: { shape: 'S5t', locationName: 'Rule' } }
					},
					ExpectedBucketOwner: { location: 'header', locationName: 'x-amz-expected-bucket-owner' }
				},
				payload: 'LifecycleConfiguration'
		...
		PutBucketLogging: {
			http: { method: 'PUT', requestUri: '/{Bucket}?logging' },
			input: {
				type: 'structure',
				...
				members: {
					...
					BucketLoggingStatus: {
						...
						xmlNamespace: { uri: 'http://s3.amazonaws.com/doc/2006-03-01/' },
						type: 'structure',
						members: { LoggingEnabled: { shape: 'S65' } }
					},
					ContentMD5: { location: 'header', locationName: 'Content-MD5' },
					ChecksumAlgorithm: { location: 'header', locationName: 'x-amz-sdk-checksum-algorithm' },
					ExpectedBucketOwner: { location: 'header', locationName: 'x-amz-expected-bucket-owner' }
		...
		PutBucketMetricsConfiguration: {
			http: { method: 'PUT', requestUri: '/{Bucket}?metrics' },
			input: {
				type: 'structure',
		...
		PutBucketNotification: {
			http: { method: 'PUT', requestUri: '/{Bucket}?notification' },
			input: {
				type: 'structure',
		...
		PutBucketOwnershipControls: {
			http: { method: 'PUT', requestUri: '/{Bucket}?ownershipControls' },
			input: {
				type: 'structure',
			...
			httpChecksum: { requestChecksumRequired: !0 }
		},
		PutBucketPolicy: {
			http: { method: 'PUT', requestUri: '/{Bucket}?policy' },
			input: {
				type: 'structure',
		...
		PutBucketReplication: {
			http: { method: 'PUT', requestUri: '/{Bucket}?replication' },
			input: {
				type: 'structure',
				...
				members: {
					...
					Token: { location: 'header', locationName: 'x-amz-bucket-object-lock-token' },
					ExpectedBucketOwner: { location: 'header', locationName: 'x-amz-expected-bucket-owner' }
				},
				payload: 'ReplicationConfiguration'
			},
		...
		PutBucketRequestPayment: {
			http: { method: 'PUT', requestUri: '/{Bucket}?requestPayment' },
			input: {
				type: 'structure',
		...
		PutBucketTagging: {
			http: { method: 'PUT', requestUri: '/{Bucket}?tagging' },
			input: {
				type: 'structure',
		...
		PutBucketVersioning: {
			http: { method: 'PUT', requestUri: '/{Bucket}?versioning' },
			input: {
				type: 'structure',
				...
				members: {
					...
					VersioningConfiguration: {
						...
						xmlNamespace: { uri: 'http://s3.amazonaws.com/doc/2006-03-01/' },
						type: 'structure',
						members: { MFADelete: { locationName: 'MfaDelete' }, Status: {} }
					},
					ExpectedBucketOwner: { location: 'header', locationName: 'x-amz-expected-bucket-owner' }
				},
		...
		PutBucketWebsite: {
			http: { method: 'PUT', requestUri: '/{Bucket}?website' },
			input: {
				type: 'structure',
		...
		PutObjectAcl: {
			http: { method: 'PUT', requestUri: '/{Bucket}/{Key+}?acl' },
			input: {
				type: 'structure',
				required: ['Bucket', 'Key'],
				members: {
		...
		PutObjectLegalHold: {
			http: { method: 'PUT', requestUri: '/{Bucket}/{Key+}?legal-hold' },
			input: {
				type: 'structure',
				required: ['Bucket', 'Key'],
				members: {
		...
		PutObjectLockConfiguration: {
			http: { method: 'PUT', requestUri: '/{Bucket}?object-lock' },
			input: {
				type: 'structure',
				required: ['Bucket'],
				members: {
		...
		PutObjectRetention: {
			http: { method: 'PUT', requestUri: '/{Bucket}/{Key+}?retention' },
			input: {
				type: 'structure',
				required: ['Bucket', 'Key'],
				members: {
		...
		PutObjectTagging: {
			http: { method: 'PUT', requestUri: '/{Bucket}/{Key+}?tagging' },
			input: {
				type: 'structure',
		...
		PutPublicAccessBlock: {
			http: { method: 'PUT', requestUri: '/{Bucket}?publicAccessBlock' },
			input: {
				type: 'structure',
		...
		RestoreObject: {
			http: { requestUri: '/{Bucket}/{Key+}?restore' },
			input: {
				type: 'structure',
				required: ['Bucket', 'Key'],
				members: {
					...
					RestoreRequest: {
						...
						members: {
							...
							SelectParameters: {
								...
								members: {
									InputSerialization: { shape: 'Se5' },
									ExpressionType: {},
									Expression: {},
									OutputSerialization: { shape: 'Sek' }
								}
							},
							OutputLocation: {
								type: 'structure',
									...
									S3: {
										...
										members: {
											...
											Encryption: {
												...
												members: { EncryptionType: {}, KMSKeyId: { shape: 'Sr' }, KMSContext: {} }
											},
											CannedACL: {},
											AccessControlList: { shape: 'S3g' },
											Tagging: { shape: 'Sdf' },
											UserMetadata: {
												type: 'list',
												member: {
			...
			output: {
				...
				members: {
					RequestCharged: { location: 'header', locationName: 'x-amz-request-charged' },
					RestoreOutputPath: { location: 'header', locationName: 'x-amz-restore-output-path' }
				}
			},
		...
		SelectObjectContent: {
			http: { requestUri: '/{Bucket}/{Key+}?select&select-type=2' },
			input: {
				...
				members: {
					...
					Expression: {},
					ExpressionType: {},
					RequestProgress: { type: 'structure', members: { Enabled: { type: 'boolean' } } },
					InputSerialization: { shape: 'Se5' },
					OutputSerialization: { shape: 'Sek' },
					ScanRange: {
						type: 'structure',
						members: { Start: { type: 'long' }, End: { type: 'long' } }
					},
					ExpectedBucketOwner: { location: 'header', locationName: 'x-amz-expected-bucket-owner' }
				}
			},
				...
				members: {
					Payload: {
						...
						members: {
							Records: {
								type: 'structure',
								members: { Payload: { eventpayload: !0, type: 'blob' } },
								event: !0
							},
							Stats: {
								type: 'structure',
							...
							Cont: { type: 'structure', members: {}, event: !0 },
							End: { type: 'structure', members: {}, event: !0 }
						},
						eventstream: !0
					}
				},
		...
		UploadPartCopy: {
			...
			input: {
				...
				members: {
					...
					CopySourceRange: { location: 'header', locationName: 'x-amz-copy-source-range' },
					Key: { location: 'uri', locationName: 'Key' },
					PartNumber: { location: 'querystring', locationName: 'partNumber', type: 'integer' },
					UploadId: { location: 'querystring', locationName: 'uploadId' },
					SSECustomerAlgorithm: {
		...
		WriteGetObjectResponse: {
			http: { requestUri: '/WriteGetObjectResponse' },
			input: {
				type: 'structure',
				required: ['RequestRoute', 'RequestToken'],
				members: {
					RequestRoute: { hostLabel: !0, location: 'header', locationName: 'x-amz-request-route' },
					RequestToken: { location: 'header', locationName: 'x-amz-request-token' },
					Body: { streaming: !0, type: 'blob' },
					StatusCode: { location: 'header', locationName: 'x-amz-fwd-status', type: 'integer' },
					ErrorCode: { location: 'header', locationName: 'x-amz-fwd-error-code' },
					ErrorMessage: { location: 'header', locationName: 'x-amz-fwd-error-message' },
					AcceptRanges: { location: 'header', locationName: 'x-amz-fwd-header-accept-ranges' },
					CacheControl: { location: 'header', locationName: 'x-amz-fwd-header-Cache-Control' },
					ContentDisposition: {
						location: 'header',
					...
					ContentLength: { location: 'header', locationName: 'Content-Length', type: 'long' },
					ContentRange: { location: 'header', locationName: 'x-amz-fwd-header-Content-Range' },
					ContentType: { location: 'header', locationName: 'x-amz-fwd-header-Content-Type' },
					ChecksumCRC32: {
						location: 'header',
					...
					ETag: { location: 'header', locationName: 'x-amz-fwd-header-ETag' },
					Expires: {
						location: 'header',
						locationName: 'x-amz-fwd-header-Expires',
						type: 'timestamp'
					},
					Expiration: { location: 'header', locationName: 'x-amz-fwd-header-x-amz-expiration' },
					LastModified: {
						location: 'header',
					...
					Restore: { location: 'header', locationName: 'x-amz-fwd-header-x-amz-restore' },
					ServerSideEncryption: {
						location: 'header',
					...
					VersionId: { location: 'header', locationName: 'x-amz-fwd-header-x-amz-version-id' },
					BucketKeyEnabled: {
						location: 'header',
			...
			endpoint: { hostPrefix: '{RequestRoute}.' }
		}
	},
	shapes: {
		Sk: { type: 'blob', sensitive: !0 },
		Sr: { type: 'string', sensitive: !0 },
		S1b: { type: 'map', key: {}, value: {} },
		S1i: { type: 'string', sensitive: !0 },
		S1k: { type: 'blob', sensitive: !0 },
		S1o: { type: 'timestamp', timestampFormat: 'iso8601' },
		S3d: { type: 'structure', members: { DisplayName: {}, ID: {} } },
		S3g: {
			type: 'list',
			member: {
				locationName: 'Grant',
				type: 'structure',
				members: { Grantee: { shape: 'S3i' }, Permission: {} }
			}
		},
		S3i: {
			type: 'structure',
			...
			members: {
				...
				EmailAddress: {},
				ID: {},
				Type: { locationName: 'xsi:type', xmlAttribute: !0 },
				URI: {}
			},
			...
			members: {
				...
				Filter: {
					...
					members: {
						...
						And: {
							type: 'structure',
							members: { Prefix: {}, Tags: { shape: 'S3v', flattened: !0, locationName: 'Tag' } }
						}
					}
				},
								...
								Destination: {
									...
									members: {
										S3BucketDestination: {
											...
											members: { Format: {}, BucketAccountId: {}, Bucket: {}, Prefix: {} }
										}
									}
								}
							}
		...
		S3s: { type: 'structure', required: ['Key', 'Value'], members: { Key: {}, Value: {} } },
		S3v: { type: 'list', member: { shape: 'S3s', locationName: 'Tag' } },
		S44: {
			type: 'list',
			member: {
				type: 'structure',
				...
				members: {
					...
					ExposeHeaders: { locationName: 'ExposeHeader', type: 'list', member: {}, flattened: !0 },
					...
					member: {
						...
						members: {
							ApplyServerSideEncryptionByDefault: {
								...
								members: { SSEAlgorithm: {}, KMSMasterKeyID: { shape: 'Sr' } }
							},
			...
			members: {
				...
				Tierings: {
					...
					member: {
						...
						members: { Days: { type: 'integer' }, AccessTier: {} }
					},
					flattened: !0
				}
			}
		...
		S4x: {
			...
			members: {
						...
						S3BucketDestination: {
							...
							members: {
								...
								Encryption: {
									type: 'structure',
									members: {
										SSES3: { locationName: 'SSE-S3', type: 'structure', members: {} },
										SSEKMS: {
											locationName: 'SSE-KMS',
											type: 'structure',
											required: ['KeyId'],
											members: { KeyId: { shape: 'Sr' } }
										}
									}
								}
							}
				...
				Filter: { type: 'structure', required: ['Prefix'], members: { Prefix: {} } },
				Id: {},
				IncludedObjectVersions: {},
				OptionalFields: { type: 'list', member: { locationName: 'Field' } },
				Schedule: { type: 'structure', required: ['Frequency'], members: { Frequency: {} } }
			}
		},
		S5d: {
			type: 'list',
			member: {
				...
				members: {
					Expiration: { shape: 'S5f' },
					ID: {},
					Prefix: {},
					Status: {},
					Transition: { shape: 'S5k' },
					NoncurrentVersionTransition: { shape: 'S5m' },
					NoncurrentVersionExpiration: { shape: 'S5o' },
					AbortIncompleteMultipartUpload: { shape: 'S5p' }
				}
			},
			flattened: !0
		},
		...
		S5g: { type: 'timestamp', timestampFormat: 'iso8601' },
		S5k: {
			type: 'structure',
			members: { Date: { shape: 'S5g' }, Days: { type: 'integer' }, StorageClass: {} }
		},
		S5m: {
			type: 'structure',
			members: {
		...
		S5o: {
			type: 'structure',
			members: { NoncurrentDays: { type: 'integer' }, NewerNoncurrentVersions: { type: 'integer' } }
		},
		S5p: { type: 'structure', members: { DaysAfterInitiation: { type: 'integer' } } },
		S5t: {
			type: 'list',
			member: {
				type: 'structure',
				...
				members: {
					...
					Filter: {
						...
						members: {
							Prefix: {},
							Tag: { shape: 'S3s' },
							ObjectSizeGreaterThan: { type: 'long' },
							ObjectSizeLessThan: { type: 'long' },
							And: {
								type: 'structure',
								members: {
									Prefix: {},
									Tags: { shape: 'S3v', flattened: !0, locationName: 'Tag' },
									ObjectSizeGreaterThan: { type: 'long' },
									ObjectSizeLessThan: { type: 'long' }
								}
							}
		...
		S6i: {
			...
			members: {
				TopicConfiguration: {
					...
					members: {
						Id: {},
						Events: { shape: 'S6l', locationName: 'Event' },
						Event: { deprecated: !0 },
						Topic: {}
					}
				},
		...
		S6l: { type: 'list', member: {}, flattened: !0 },
		S6t: {
			type: 'structure',
			members: {
				TopicConfigurations: {
				...
				LambdaFunctionConfigurations: {
					...
					member: {
						...
						members: {
							Id: {},
							LambdaFunctionArn: { locationName: 'CloudFunction' },
							Events: { shape: 'S6l', locationName: 'Event' },
							Filter: { shape: 'S6w' }
						}
					},
				...
				EventBridgeConfiguration: { type: 'structure', members: {} }
			}
		},
		S6w: {
			type: 'structure',
						...
						members: {
							...
							Destination: {
								...
								members: {
									...
									EncryptionConfiguration: { type: 'structure', members: { ReplicaKmsKeyID: {} } },
									ReplicationTime: {
										type: 'structure',
										required: ['Status', 'Time'],
										members: { Status: {}, Time: { shape: 'S88' } }
									},
									Metrics: {
										type: 'structure',
										required: ['Status'],
										members: { Status: {}, EventThreshold: { shape: 'S88' } }
									}
								}
							},
							DeleteMarkerReplication: { type: 'structure', members: { Status: {} } }
						}
					},
					flattened: !0
				}
		...
		S88: { type: 'structure', members: { Minutes: { type: 'integer' } } },
		S8p: { type: 'structure', required: ['HostName'], members: { HostName: {}, Protocol: {} } },
		S8s: { type: 'structure', required: ['Suffix'], members: { Suffix: {} } },
		S8u: { type: 'structure', required: ['Key'], members: { Key: {} } },
		S8v: {
			type: 'list',
			member: {
				...
				members: {
					Condition: {
						type: 'structure',
						members: { HttpErrorCodeReturnedEquals: {}, KeyPrefixEquals: {} }
					},
					Redirect: {
						type: 'structure',
						members: {
		...
		Sa9: { type: 'structure', members: { Status: {} } },
		Sac: {
			type: 'structure',
			members: {
				ObjectLockEnabled: {},
				Rule: {
					...
					members: {
						DefaultRetention: {
							type: 'structure',
							members: { Mode: {}, Days: { type: 'integer' }, Years: { type: 'integer' } }
						}
					}
				}
			}
		},
		Sak: { type: 'structure', members: { Mode: {}, RetainUntilDate: { shape: 'S5g' } } },
		Sar: {
			type: 'structure',
			members: {
				BlockPublicAcls: { locationName: 'BlockPublicAcls', type: 'boolean' },
				IgnorePublicAcls: { locationName: 'IgnorePublicAcls', type: 'boolean' },
				BlockPublicPolicy: { locationName: 'BlockPublicPolicy', type: 'boolean' },
				RestrictPublicBuckets: { locationName: 'RestrictPublicBuckets', type: 'boolean' }
			}
		},
		Sbr: { type: 'structure', members: { ID: {}, DisplayName: {} } },
		Sbs: { type: 'list', member: { type: 'structure', members: { Prefix: {} } }, flattened: !0 },
		Sc1: { type: 'list', member: {}, flattened: !0 },
		Sca: {
			type: 'list',
			member: {
				type: 'structure',
		...
		Sdf: { type: 'structure', required: ['TagSet'], members: { TagSet: { shape: 'S3v' } } },
		Se5: {
			type: 'structure',
			members: {
				CSV: {
				...
				CompressionType: {},
				JSON: { type: 'structure', members: { Type: {} } },
				Parquet: { type: 'structure', members: {} }
			}
		},
		Sek: {
			type: 'structure',
			members: {
				...
				JSON: { type: 'structure', members: { RecordDelimiter: {} } }
			}
		}
	},
	paginators: {
	...
	(_xamzrequire = (function e(n, i, t) {
	...
	})(
		{
			117: [
				...
				{ '../config_regional_endpoint': 43, '../core': 44 }
			]
		},
		{},
		[117]
	...
	operations: {
		AssumeRole: {
			...
			output: {
				...
				type: 'structure',
				members: {
					Credentials: { shape: 'Si' },
					AssumedRoleUser: { shape: 'Sn' },
		...
		DecodeAuthorizationMessage: {
			input: { type: 'structure', required: ['EncodedMessage'], members: { EncodedMessage: {} } },
			output: {
		...
		GetAccessKeyInfo: {
			input: { type: 'structure', required: ['AccessKeyId'], members: { AccessKeyId: {} } },
			output: {
		...
		GetSessionToken: {
			input: {
				type: 'structure',
				members: { DurationSeconds: { type: 'integer' }, SerialNumber: {}, TokenCode: {} }
			},
			output: {
				resultWrapper: 'GetSessionTokenResult',
				type: 'structure',
				members: { Credentials: { shape: 'Si' } }
			}
		}
	},
	shapes: {
		...
		S8: {
			type: 'list',
			member: { type: 'structure', required: ['Key', 'Value'], members: { Key: {}, Value: {} } }
		},
		Si: {
			type: 'structure',
